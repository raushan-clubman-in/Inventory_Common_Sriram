...
Public Class CryPOGSTNEW_CFC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOGSTNEW_CFC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPOGSTNEW_CFC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOGSTNEW_CFC = New CryPOGSTNEW_CFC()
        rpt.Site = Me.Site
        Return rpt
    End Function
