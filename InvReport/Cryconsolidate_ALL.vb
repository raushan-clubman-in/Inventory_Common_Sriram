...
Public Class Cryconsolidate_ALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cryconsolidate_ALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryconsolidate_ALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cryconsolidate_ALL = New Cryconsolidate_ALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
