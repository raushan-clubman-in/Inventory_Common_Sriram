...
Public Class Rpt_Deliveryterms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Deliveryterms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Deliveryterms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Deliveryterms = New Rpt_Deliveryterms()
        rpt.Site = Me.Site
        Return rpt
    End Function
