...
Public Class CryRecieptRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryRecieptRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRecieptRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRecieptRegister = New CryRecieptRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
