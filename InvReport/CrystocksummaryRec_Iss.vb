...
Public Class CrystocksummaryRec_Iss
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystocksummaryRec_Iss.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CrystocksummaryRec_Iss.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystocksummaryRec_Iss
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystocksummaryRec_Iss = New CrystocksummaryRec_Iss()
        rpt.Site = Me.Site
        Return rpt
    End Function
