...
Public Class PendingposReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.PendingposReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPendingposReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PendingposReport = New PendingposReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
