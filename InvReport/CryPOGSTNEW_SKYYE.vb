...
Public Class CryPOGSTNEW_SKYYE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOGSTNEW_SKYYE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPOGSTNEW_SKYYE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOGSTNEW_SKYYE = New CryPOGSTNEW_SKYYE()
        rpt.Site = Me.Site
        Return rpt
    End Function
