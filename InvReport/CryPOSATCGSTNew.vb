...
Public Class CryPOSATCGSTNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOSATCGSTNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPOSATCGSTNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOSATCGSTNew = New CryPOSATCGSTNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
