...
Public Class CrystocksummaryCL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CrystocksummaryCL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystocksummaryCL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystocksummaryCL = New CrystocksummaryCL()
        rpt.Site = Me.Site
        Return rpt
    End Function
