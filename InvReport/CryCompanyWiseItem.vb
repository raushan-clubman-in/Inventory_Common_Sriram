...
Public Class CryCompanyWiseItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryCompanyWiseItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryCompanyWiseItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryCompanyWiseItem = New CryCompanyWiseItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
