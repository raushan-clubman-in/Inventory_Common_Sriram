...
Public Class TaxReportdetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.TaxReportdetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTaxReportdetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TaxReportdetails = New TaxReportdetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
