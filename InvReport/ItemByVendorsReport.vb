...
Public Class ItemByVendorsReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ItemByVendorsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.ItemByVendorsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItemByVendorsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ItemByVendorsReport = New ItemByVendorsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
