...
Public Class CryPenIndentIssue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPenIndentIssue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPenIndentIssue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPenIndentIssue = New CryPenIndentIssue()
        rpt.Site = Me.Site
        Return rpt
    End Function
