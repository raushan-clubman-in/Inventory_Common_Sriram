...
Public Class CryMinMaxReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryMinMaxReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryMinMaxReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryMinMaxReport = New CryMinMaxReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
