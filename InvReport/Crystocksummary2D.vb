...
Public Class Crystocksummary2D
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Crystocksummary2D.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystocksummary2D
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystocksummary2D = New Crystocksummary2D()
        rpt.Site = Me.Site
        Return rpt
    End Function
