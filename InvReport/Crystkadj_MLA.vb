...
Public Class Crystkadj_MLA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Crystkadj_MLA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystkadj_MLA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystkadj_MLA = New Crystkadj_MLA()
        rpt.Site = Me.Site
        Return rpt
    End Function
