...
Public Class FrmConsumption
    ...
    Private Sub FillStore()
        Dim sqlstring As String
        Dim i As Integer
        sqlstring = "SELECT DISTINCT ISNULL(STOREcode,'') + '- '+ ISNULL(STOREdesc,'') AS STOREdesc FROM [Vw_Store_Costcenter] WHERE isnull(storestatus,'') = 'C'  ORDER BY STOREdesc ASC"
    ...
    Private Sub FrmConsumption_Load(sender As Object, e As EventArgs) Handles MyBase.Load
