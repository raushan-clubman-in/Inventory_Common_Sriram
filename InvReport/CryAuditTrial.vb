...
Public Class CryAuditTrial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryAuditTrial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAuditTrial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAuditTrial = New CryAuditTrial()
        rpt.Site = Me.Site
        Return rpt
    End Function
