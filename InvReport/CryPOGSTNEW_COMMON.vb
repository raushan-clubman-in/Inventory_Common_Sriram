...
Public Class CryPOGSTNEW_COMMON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOGSTNEW_COMMON.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DeliveryDet_My_Parameter_2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCryPOGSTNEW_COMMON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOGSTNEW_COMMON = New CryPOGSTNEW_COMMON()
        rpt.Site = Me.Site
        Return rpt
    End Function
