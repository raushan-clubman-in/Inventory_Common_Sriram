...
Public Class FReEStockREpoRt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.FReEStockREpoRt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFReEStockREpoRt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FReEStockREpoRt = New FReEStockREpoRt()
        rpt.Site = Me.Site
        Return rpt
    End Function
