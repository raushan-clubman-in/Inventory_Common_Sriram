...
Public Class CryIssueReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryIssueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryIssueReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryIssueReport = New CryIssueReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
