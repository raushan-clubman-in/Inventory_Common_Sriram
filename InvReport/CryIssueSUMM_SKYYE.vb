...
Public Class CryIssueSUMM_SKYYE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryIssueSUMM_SKYYE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryIssueSUMM_SKYYE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryIssueSUMM_SKYYE = New CryIssueSUMM_SKYYE()
        rpt.Site = Me.Site
        Return rpt
    End Function
