...
Public Class SALVAGE_REPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.SALVAGE_REPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALVAGE_REPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALVAGE_REPORT = New SALVAGE_REPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
