...
Public Class InvStockConsumption
    ...
    Sub viewoperation()
        Try
            ...
            sqlstring = "exec cp_stockconsumption"
            gconnection.ExcuteStoreProcedure(sqlstring)

            If CheckBox1.Checked = True Then
                Dim r As New CryconsumptionreportByItemWise


                If CheckedListBox1.CheckedItems.Count <> 0 Then
                    sqlstring = " SELECT itemcode,itemname,uom,sum(qty) AS QTY,sum(amount) AS amount,sum(amount)/sum(qty)  AS RATE FROM TEMPSTOCKCONSUMPTIONDETAIL "
                    sqlstring = sqlstring & " WHERE isnull(VOID,'N')<>'Y' AND storecode IN ("
                ...
                sqlstring = sqlstring & "  GROUP BY itemcode,itemname,uom HAVING SUM(QTY)<>0"
            ...
            Else
                Dim r As New Cryconsumptionreport
                sqlstring = " SELECT * FROM TEMPSTOCKCONSUMPTIONDETAIL "
                If CheckedListBox1.CheckedItems.Count <> 0 Then
                    sqlstring = " SELECT * FROM TEMPSTOCKCONSUMPTIONDETAIL "
                    sqlstring = sqlstring & " WHERE isnull(VOID,'N')<>'Y' AND storecode IN ("
                    For i = 0 To CheckedListBox1.CheckedItems.Count - 1
    ...
    Private Sub InvStockConsumption_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub InvStockConsumption_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub InvStockConsumption_LocationChanged(sender As Object, e As EventArgs) Handles Me.LocationChanged
