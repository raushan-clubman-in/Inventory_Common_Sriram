...
Public Class CryPOGSTNEW_NIZAM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOGSTNEW_NIZAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPOGSTNEW_NIZAM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOGSTNEW_NIZAM = New CryPOGSTNEW_NIZAM()
        rpt.Site = Me.Site
        Return rpt
    End Function
