...
Public Class CryPOGSTNEW_KBA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOGSTNEW_KBA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPOGSTNEW_KBA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOGSTNEW_KBA = New CryPOGSTNEW_KBA()
        rpt.Site = Me.Site
        Return rpt
    End Function
