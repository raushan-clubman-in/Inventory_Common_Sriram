...
Public Class CryPurchaseRETURN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPurchaseRETURN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPurchaseRETURN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPurchaseRETURN = New CryPurchaseRETURN()
        rpt.Site = Me.Site
        Return rpt
    End Function
