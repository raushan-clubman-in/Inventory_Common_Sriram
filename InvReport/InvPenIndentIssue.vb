...
Public Class InvPenIndentIssue
    ...
    Private Sub VIEWISSUEREGISTER()
        Try
            ...
            Dim i As Integer
            Dim r As New CryPenIndentIssue
            Dim rViewer As New Viewer

            Me.Cursor = Cursors.WaitCursor
            ' sqlstring = "exec cp_stockissue"
            'gconnection.ExcuteStoreProcedure(sqlstring)
            sqlstring = " SELECT * FROM Vw_INdentIssue "
            If CheckedListBox1.CheckedItems.Count <> 0 Then
                sqlstring = sqlstring & " WHERE  storelocationCODE IN ("
            ...
            '    Exit Sub
            'End If
            sqlstring = sqlstring & " AND CAST(CONVERT(VARCHAR(11),INDENT_DATE ,106) AS DATETIME) BETWEEN"
            ...
            gconnection.getDataSet(sqlstring, "Vw_INdentIssue")
            If gdataset.Tables("Vw_INdentIssue").Rows.Count > 0 Then
                rViewer.ssql = sqlstring
                rViewer.Report = r
                rViewer.TableName = "Vw_INdentIssue"
                'COMPANY NAME
    ...
    Private Sub ButExport_Click(sender As Object, e As EventArgs) Handles ButExport.Click
        Try
            ...
            If gdataset.Tables("Vw_INdentIssue").Rows.Count > 0 Then
                ...
                exp.Show()
                Call exp.export(sqlstring, "PENDING INDENT ISSUE DETAIL " & Format(dtpfromdate.Value, "dd-MMM-yyyy") & "TO" & Format(dtptodate.Value, "dd-MMM-yyyy"), "")
