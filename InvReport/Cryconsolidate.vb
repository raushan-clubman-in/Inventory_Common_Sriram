...
Public Class Cryconsolidate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cryconsolidate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryconsolidate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cryconsolidate = New Cryconsolidate()
        rpt.Site = Me.Site
        Return rpt
    End Function
