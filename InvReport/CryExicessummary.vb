...
Public Class CryExicessummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryExicessummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryExicessummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryExicessummary = New CryExicessummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
