...
Public Class PowiseGRNreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.PowiseGRNreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPowiseGRNreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PowiseGRNreport = New PowiseGRNreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
