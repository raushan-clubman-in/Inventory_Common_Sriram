...
Public Class CryRecieptRegisterCCL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryRecieptRegisterCCL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryRecieptRegisterCCL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRecieptRegisterCCL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRecieptRegisterCCL = New CryRecieptRegisterCCL()
        rpt.Site = Me.Site
        Return rpt
    End Function
