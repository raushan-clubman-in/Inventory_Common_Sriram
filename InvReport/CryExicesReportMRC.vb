...
Public Class CryExicesReportMRC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryExicesReportMRC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryExicesReportMRC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryExicesReportMRC = New CryExicesReportMRC()
        rpt.Site = Me.Site
        Return rpt
    End Function
