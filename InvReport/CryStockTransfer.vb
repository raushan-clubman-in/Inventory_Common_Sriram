...
Public Class CryStockTransfer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryStockTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryStockTransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryStockTransfer = New CryStockTransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
