...
Public Class Crystocksummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Crystocksummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystocksummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystocksummary = New Crystocksummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
