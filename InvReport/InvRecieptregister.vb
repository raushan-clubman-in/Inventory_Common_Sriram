...
Public Class InvRecieptregister
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(InvRecieptregister))
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(614, 124)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(159, 273)
        ...
        Me.ButExport.Location = New System.Drawing.Point(6, 164)
        ...
        Me.Cmd_Exit.Location = New System.Drawing.Point(6, 213)
        ...
        Me.Cmd_View.Location = New System.Drawing.Point(6, 65)
        ...
        Me.Cmd_Clear.Location = New System.Drawing.Point(6, 16)
        ...
        Me.chkdetail.Location = New System.Drawing.Point(423, 582)
        ...
        Me.chksummary.Location = New System.Drawing.Point(418, 559)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(536, 351)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(412, 35)
        ...
        Me.Label5.Location = New System.Drawing.Point(266, 35)
        Me.Label5.Name = "Label5"
        Me.Label5.Size = New System.Drawing.Size(199, 24)
        Me.Label5.TabIndex = 508
        Me.Label5.Text = "SELECT SUPPLIER CODE :  "
        '
        'ChkItemCode
        '
        ...
        Me.ChkItemCode.Location = New System.Drawing.Point(132, 49)
        ...
        Me.ChkCategory.Location = New System.Drawing.Point(-74, 49)
        ...
        Me.ChkSupplier.Location = New System.Drawing.Point(265, 16)
        ...
        Me.CheckedListBox3.Location = New System.Drawing.Point(132, 72)
        ...
        Me.CheckedListBox2.Location = New System.Drawing.Point(-74, 72)
        ...
        Me.CheckedListBox1.Location = New System.Drawing.Point(265, 63)
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(25, 484)
        ...
        Me.Label16.Location = New System.Drawing.Point(272, 9)
        Me.Label16.Name = "Label16"
        Me.Label16.Size = New System.Drawing.Size(217, 23)
        Me.Label16.TabIndex = 491
        Me.Label16.Text = "RECIEPT REGISTER"
        ...
        Me.ClientSize = New System.Drawing.Size(804, 648)
...
#End Region
    ...
    End Sub
    Private Sub ViewPurchaseRegisterNONCCL()
        Try
            ...
            Dim s As New CryRecieptRegister
            ...
            sqlstring = " select  isnull(grnno,0) as grnno, 	grndetails,	grndate,	pono,	Supplierinvno,	Suppliercode,	Suppliername,	Itemcode,	Itemname,	uom	,sum(qty)as qty 	,rate	,sum(baseamount) as baseamount,	sum(discper) as 	discper,sum(taxper	) as taxper,sum(Discount) as Discount	,sum(taxamount) as taxamount 	,sum(amount) as amount	,taxcode,	batchno,	sum(othcharge) as othcharge	,Voiditem	,category,	storecode	,storedesc	,versionno,	grntype,sum(	amountafterdiscount) as amountafterdiscount	,Totalamount as Totalamount ,sum(	VATamount) as VATamount,	sum(Surchargeamt ) as Surchargeamt	,sum(OverallDiscount ) as OverallDiscount,	sum(totdiscount) as totdiscount,Billamount as Billamount,	Remarks,	Void,	updateuser,	updatedate,	voiduser	,voiddate,Supplierdate,	SPONSORCODE  from vw_purchaseregisterNew "
            ...
            sqlstring = sqlstring & " '" & Format(dtpfromdate.Value, "dd/MMM/yyyy") & "' AND ' " & Format(dtptodate.Value, "dd/MMM/yyyy") & "'  group by  grnno, 	grndetails,	grndate,	pono,	Supplierinvno,	Suppliercode,	Suppliername,	Itemcode,	Itemname,	uom	 	,rate	,taxcode,	batchno,	othcharge	,Voiditem	,category,	storecode	,storedesc	,versionno,	grntype,	Surchargeamt	,OverallDiscount,	totdiscount,Billamount,	Remarks,	Void,	updateuser,	updatedate,	voiduser	,voiddate,Supplierdate,	SPONSORCODE,Billamount,Totalamount order by grndate"
            Me.Cursor = Cursors.WaitCursor
            ...
            If gdataset.Tables("vw_purchaseregister").Rows.Count > 0 Then
                ...
                textobj1 = s.ReportDefinition.ReportObjects("Text42")
                textobj1.Text = MyCompanyName

                If UCase(gShortname) = "JIC" Or Mid(UCase(Trim(gCompanyname)), 1, 3) = "JUB" Then
                    Dim textobj5 As TextObject
                    textobj5 = s.ReportDefinition.ReportObjects("Text43")
                    textobj5.Text = ""
                Else
                    ...
                    'Dim textobj5 As TextObject
                    'textobj5 = s.ReportDefinition.ReportObjects("Text45")
                ...
                TXTOBJ3 = s.ReportDefinition.ReportObjects("Text44")
    ...
    Private Sub ViewPurchaseRegister()
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            Dim s As New CryRecieptRegisterCCL
