...
Public Class InvAdjustmentReport
    ...
    Private Sub InvAdjustmentReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
        ...
        End Try
    End Sub
    Private Sub InvAdjustmentReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub VIEWADJREGISTER()


        Try
            Dim sqlstring, ITEMcode(), STORECODE() As String
            Dim i As Integer
            Dim r As New Cryadjreport
            Dim rViewer As New Viewer



            Me.Cursor = Cursors.WaitCursor
               sqlstring = "exec cp_stockadjustment"
            gconnection.ExcuteStoreProcedure(sqlstring)
            sqlstring = " SELECT * FROM TEMPSTOCKadjDETAIL "
            ...
            If gdataset.Tables("ISSUEREGISTER").Rows.Count > 0 Then
                ...
                rViewer.Report = r
                rViewer.TableName = "adjustmentREGISTER"
               ...
               'PERIOD
                ...
                TXTOBJ63 = r.ReportDefinition.ReportObjects("Text20")
    ...
    Private Sub ButExport_Click(sender As Object, e As EventArgs) Handles ButExport.Click
        ...
        Try
            ...
            sqlstring = "exec cp_stockadjustment"
            gconnection.ExcuteStoreProcedure(sqlstring)
            sqlstring = " SELECT Docdetails,	docdate,	Storecode,	StoreDESC,	itemcode,	itemname,	uom	,ISNULL(STOCKINHAND,0) AS STOCKINHAND,	ISNULL(ADJUSTEDSTOCK,0) AS ADJUSTEDSTOCK,	ISNULL(PHYSICALSTOCK,0) AS PHYSICALSTOCK	,	ISNULL(rate,0) AS rATE,	ISNULL(amount,0) AS AMOUNT FROM TEMPSTOCKadjDETAIL "
            If CheckedListBox1.CheckedItems.Count <> 0 Then
                sqlstring = sqlstring & " WHERE storecode IN ("
                For i = 0 To CheckedListBox1.CheckedItems.Count - 1
                    STORECODE = Split(CheckedListBox1.CheckedItems(i), "-")
            ...
            If gdataset.Tables("ISSUEREGISTER").Rows.Count > 0 Then
                ...
                exp.Show()
                Call exp.export(sqlstring, "Adjustment Report " & Format(dtpfromdate.Value, "dd-MMM-yyyy") & "TO" & Format(dtptodate.Value, "dd-MMM-yyyy"), "")
