...
Public Class CrystocksummaryLIQ
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CrystocksummaryLIQ.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystocksummaryLIQ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystocksummaryLIQ = New CrystocksummaryLIQ()
        rpt.Site = Me.Site
        Return rpt
    End Function
