...
Public Class TaxReporTRevChr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.TaxReporTRevChr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTaxReporTRevChr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TaxReporTRevChr = New TaxReporTRevChr()
        rpt.Site = Me.Site
        Return rpt
    End Function
