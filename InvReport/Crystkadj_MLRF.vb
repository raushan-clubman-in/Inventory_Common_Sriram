...
Public Class Crystkadj_MLRF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Crystkadj_MLRF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystkadj_MLRF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystkadj_MLRF = New Crystkadj_MLRF()
        rpt.Site = Me.Site
        Return rpt
    End Function
