...
Public Class CryREorderReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryREorderReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryREorderReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryREorderReport = New CryREorderReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
