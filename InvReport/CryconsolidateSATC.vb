...
Public Class CryconsolidateSATC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryconsolidateSATC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryconsolidateSATC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryconsolidateSATC = New CryconsolidateSATC()
        rpt.Site = Me.Site
        Return rpt
    End Function
