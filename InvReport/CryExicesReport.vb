...
Public Class CryExicesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryExicesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryExicesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryExicesReport = New CryExicesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
