...
Public Class CryExicesReportCFC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryExicesReportCFC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryExicesReportCFC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryExicesReportCFC = New CryExicesReportCFC()
        rpt.Site = Me.Site
        Return rpt
    End Function
