...
Public Class Crystockledgerreport1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crystockledgerreport.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Crystockledgerreport.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedCrystockledgerreport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystockledgerreport = New Crystockledgerreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
