...
Public Class StoreWise_Consolodated_Report

    Dim gconnection As New GlobalClass
    Dim sqlstring As String

    Private Sub StoreWise_Consolodated_Issue_Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub VIEWISSUEREGISTER()
        Try
            ...
            Dim i As Integer
            Dim r As New CryStoreConsolidated
            Dim rViewer As New Viewer

            Me.Cursor = Cursors.WaitCursor
            sqlstring = "exec reportgeneratereciss '" & Format(dtpfromdate.Value, "yyyy-MM-dd") & "' , ' " & Format(dtptodate.Value, "yyyy-MM-dd") & "',''"
            gconnection.ExcuteStoreProcedure(sqlstring)
            sqlstring = "select * from reportgeneraterecisstab where "


            If CheckedListBox1.CheckedItems.Count <> 0 Then
                sqlstring = sqlstring & "   storecode IN ("
            ...
            gconnection.getDataSet(sqlstring, "reportgeneraterecisstab")
            If gdataset.Tables("reportgeneraterecisstab").Rows.Count > 0 Then
                rViewer.ssql = sqlstring
                rViewer.Report = r
                rViewer.TableName = "reportgeneraterecisstab"
                ...
                textobj22 = r.ReportDefinition.ReportObjects("Text18")
    ...
    Private Sub ButExport_Click(sender As Object, e As EventArgs) Handles ButExport.Click
        Try
            ...
            If gdataset.Tables("reportgeneraterecisstab").Rows.Count > 0 Then
                ...
                exp.Show()
                Call exp.export(sqlstring, "StoreWise Consolidated Issue " & Format(dtpfromdate.Value, "dd-MMM-yyyy") & "TO" & Format(dtptodate.Value, "dd-MMM-yyyy"), "")
