...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'CryRptViewer
        '
        Me.CryRptViewer.AccessibleRole = System.Windows.Forms.AccessibleRole.ScrollBar
        Me.CryRptViewer.ActiveViewIndex = -1
        Me.CryRptViewer.AutoScroll = True
        ...
        Me.CryRptViewer.Size = New System.Drawing.Size(1008, 730)
        Me.CryRptViewer.TabIndex = 0
...
#End Region
    ...
    Public Function GetDetails(ByVal sqlstring As String, ByVal Tabname As String, ByVal rpt As Object)
        Try
            ...
            adp.SelectCommand.CommandTimeout = 100000000
            adp.Fill(ds, Tabname)
    ...
    Public Function GetDetails1(ByVal ds As DataSet, ByVal rpt As Object)
        Try
            'myconn = New SqlConnection(gconnection.Getconnection())
            'Dim adp As New SqlDataAdapter
            'Dim ds As New DataSet
    ...
    Public Function GetDetails1New(ByVal ssql As String, ByVal Tab As String, ByVal rpt As Object)
