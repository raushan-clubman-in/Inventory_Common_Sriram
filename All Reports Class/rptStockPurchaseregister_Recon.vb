...
Imports System.io
Public Class rptStockPurchaseregister_Recon
                        ...
                        If gdataset.Tables("VIEWPURCHASEREGISTERSUMMARY").Rows.Count > 0 Then
                            For I = 0 To gdataset.Tables("VIEWPURCHASEREGISTERSUMMARY").Rows.Count - 1 Step 1
                                With gdataset.Tables("VIEWPURCHASEREGISTERSUMMARY").Rows(I)
                                    ...
                                    dblBasicamount = Format(Val(.Item("TOTALAMOUNT")), "0.00")
                            ...
                            Filewrite.WriteLine(StrDup(135, "."))
                            pagesize = pagesize + 1
                            Filewrite.WriteLine("{0,-20}{1,-35}{2,20}{3,-20}{4,12}{5,15}", "PAID DETAILS", AVOUCHERDETAILS, "BASIC :", "", "", Format(Val(dblBasicamount), "0.00"))
                            pagesize = pagesize + 1
                            ...
                            dblGranddiscountamt = dblGranddiscountamt + Format(Val(dbldiscountamt), "0.00")
