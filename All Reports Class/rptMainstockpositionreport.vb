...
Imports System.io
Public Class rptMainstockpositionreport
        ...
        With GRID
            ...
            For Each DR In gdataset.Tables("GRIDVIEW").Rows
                If Trim(ITEMCODE) <> Trim(gdataset.Tables("GRIDVIEW").Rows(I).Item("ITEMCODE")) Then
                    ...
                    .FontBold = True
                    .CellType = FPSpreadADO.CellTypeConstants.CellTypeNumber
                    .Text = Format(Val(gdataset.Tables("gridview").Rows(I).Item("ISSQTY")), "0")

                    .Row = ROW
                    .Col = 12
                    .FontBold = True
                    .CellType = FPSpreadADO.CellTypeConstants.CellTypeNumber
                    .Text = Format(Val(gdataset.Tables("gridview").Rows(I).Item("ISSRATE")), "0")

                    .Row = ROW
                    .Col = 13
                    .FontBold = True
                    .CellType = FPSpreadADO.CellTypeConstants.CellTypeNumber
                    .Text = Format(Val(gdataset.Tables("gridview").Rows(I).Item("ISSVAL")), "0")
