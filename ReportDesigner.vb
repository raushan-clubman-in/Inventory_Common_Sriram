...
Public Class ReportDesigner
            ...
            If gdataset.Tables("ReportTable").Rows.Count > 0 Then
                ...
                For rowj = 0 To gdataset.Tables("ReportTable").Rows.Count - 1
                    If Vrowcount = 0 Then
                        ...
                        vheader = Chr(27) + "E" & Address1 & Chr(27) + "F"
                        ...
                        Else
                            ssql = ssql & Space(totsize) & "Page Number: " & vpagenumber
                        End If
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        If e.KeyCode = Keys.F9 And BUT_GEN_VIEW.Visible = True Then
            Call BUT_GEN_VIEW_Click(BUT_GEN_VIEW, e)
            Exit Sub
        End If
        If e.KeyCode = Keys.F11 Or e.KeyCode = Keys.Escape Then
            Call BUT_EXIT_Click(BUT_EXIT, e)
            Exit Sub
        End If
        If e.KeyCode = Keys.F10 And BUT_GV_PRINT.Visible = True Then
            Call BUT_GV_PRINT_Click(BUT_GV_PRINT, e)
            Exit Sub
        End If
    End Sub
End Class