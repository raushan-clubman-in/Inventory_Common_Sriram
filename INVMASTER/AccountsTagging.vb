...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AccountsTagging))
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(651, 427)
        ...
        Me.ssgrid.Size = New System.Drawing.Size(573, 393)
        ...
        Me.Label2.Location = New System.Drawing.Point(199, 570)
        ...
        Me.Label3.Location = New System.Drawing.Point(199, 592)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(866, 211)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(140, 146)
        Me.GroupBox2.TabIndex = 379
        ...
        Me.cmdexit.Location = New System.Drawing.Point(11, 65)
        ...
        Me.cmdsave.Location = New System.Drawing.Point(11, 16)
        ...
        Me.ClientSize = New System.Drawing.Size(1115, 662)
...
#End Region
    ...
    Sub bindcodefield()
        Dim sql1 As String = "Select taxCode,taxdescription,glaccountcode,glaccountdesc,slcode,sldesc from TaxAccountstagging where tablename='" & tabname & "' UNION "
        sql1 = sql1 & " SELECT distinct " & CodeField & "," & Codedesc & ",'' AS glaccountcode,'' AS glaccountdesc,'' AS slcode,'' AS sldesc  FROM " & tabname & " "
        sql1 = sql1 & " WHERE " & CodeField & " NOT IN (Select taxCode from TaxAccountstagging where tablename='" & tabname & "') "
        'order by " & Codeorderfield

        gconnection.getDataSet(sql1, "Accountstagging")
        If gdataset.Tables("Accountstagging").Rows.Count > 0 Then
            For i As Integer = 0 To gdataset.Tables("Accountstagging").Rows.Count - 1
                With ssgrid
                    .Row = i + 1
                    .Col = 1
                    .Text = gdataset.Tables("Accountstagging").Rows(i).Item("taxCode")

                    .Row = i + 1
                    .Col = 2
                    .Text = gdataset.Tables("Accountstagging").Rows(i).Item("taxdescription")
                    .Row = i + 1
                    .Col = 3
                    .Text = gdataset.Tables("Accountstagging").Rows(i).Item("glaccountcode")
                    .Row = i + 1
                    .Col = 4
                    .Text = gdataset.Tables("Accountstagging").Rows(i).Item("glaccountdesc")
                    .Row = i + 1
                    .Col = 5
                    .Text = gdataset.Tables("Accountstagging").Rows(i).Item("slcode")
                    .Row = i + 1
                    .Col = 6
                    .Text = gdataset.Tables("Accountstagging").Rows(i).Item("sldesc")
                    .Row = i + 1
                    '.Col = 7
