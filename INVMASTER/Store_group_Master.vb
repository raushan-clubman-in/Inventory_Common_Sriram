...
Public Class Store_group_master
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim Cmd_Exit1 As System.Windows.Forms.Button
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Store_group_master))
        ...
        Cmd_Exit1 = New System.Windows.Forms.Button()
        ...
        'Cmd_Exit1
        '
        Cmd_Exit1.BackColor = System.Drawing.Color.WhiteSmoke
        Cmd_Exit1.FlatAppearance.BorderSize = 0
        Cmd_Exit1.FlatAppearance.CheckedBackColor = System.Drawing.Color.Transparent
        Cmd_Exit1.FlatAppearance.MouseDownBackColor = System.Drawing.Color.Transparent
        Cmd_Exit1.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Transparent
        Cmd_Exit1.FlatStyle = System.Windows.Forms.FlatStyle.Popup
        Cmd_Exit1.Font = New System.Drawing.Font("Arial", 9.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Cmd_Exit1.ForeColor = System.Drawing.Color.Black
        Cmd_Exit1.Image = CType(resources.GetObject("Cmd_Exit1.Image"), System.Drawing.Image)
        Cmd_Exit1.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft
        Cmd_Exit1.Location = New System.Drawing.Point(11, 309)
        Cmd_Exit1.Name = "Cmd_Exit1"
        Cmd_Exit1.Size = New System.Drawing.Size(124, 46)
        Cmd_Exit1.TabIndex = 8
        Cmd_Exit1.Text = "Exit[F11]"
        Cmd_Exit1.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        Cmd_Exit1.UseVisualStyleBackColor = False
        AddHandler Cmd_Exit1.Click, AddressOf Me.Cmd_Exit_Click
        '
        'lbl_Heading
        '
        ...
        Me.lbl_Heading.Location = New System.Drawing.Point(232, 23)
        Me.lbl_Heading.Name = "lbl_Heading"
        Me.lbl_Heading.Size = New System.Drawing.Size(238, 22)
        Me.lbl_Heading.TabIndex = 9
        Me.lbl_Heading.Text = "STORE GROUP MASTER"
        ...
        Me.txt_CATEGORYDesc.Location = New System.Drawing.Point(215, 91)
        ...
        Me.txt_CATEGORYCode.Location = New System.Drawing.Point(215, 49)
        ...
        Me.lbl_StoreDescription.Size = New System.Drawing.Size(170, 15)
        Me.lbl_StoreDescription.TabIndex = 13
        Me.lbl_StoreDescription.Text = "STORE GROUP DESCRIPTION"
        '
        'lbl_StoreCode
        '
        ...
        Me.lbl_StoreCode.Size = New System.Drawing.Size(125, 15)
        Me.lbl_StoreCode.TabIndex = 11
        Me.lbl_StoreCode.Text = "STORE GROUP CODE"
        '
        'cmdStoreCode
        '
        ...
        Me.cmdStoreCode.Location = New System.Drawing.Point(309, 46)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(117, 137)
        ...
        Me.Label16.Location = New System.Drawing.Point(348, 49)
        ...
        Me.lbl_Freeze.Location = New System.Drawing.Point(178, 346)
        ...
        Me.cmd_auth.Location = New System.Drawing.Point(11, 261)
        ...
        Me.cmd_export.Location = New System.Drawing.Point(10, 259)
        ...
        Me.cmd_rpt.Location = New System.Drawing.Point(11, 210)
        ...
        Me.GroupBox2.Controls.Add(Cmd_Exit1)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(638, 115)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(141, 418)
        ...
        Me.Button1.Location = New System.Drawing.Point(11, 358)
        ...
        Me.ClientSize = New System.Drawing.Size(815, 586)
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        If Cmd_Add.Text = "Add [F7]" Then
            ...
            strSQL = " INSERT INTO INVENTORYSTOREGROUPMASTER (STOREGROUPcode,STOREGROUPdesc,Freeze,Adduser,Adddate)"
            strSQL = strSQL & " VALUES ( '" & Trim(txt_CATEGORYCode.Text) & "','" & Replace(Trim(txt_CATEGORYDesc.Text), "'", "") & "',"
            strSQL = strSQL & "'N',"
            strSQL = strSQL & " '" & Trim(gUsername) & "',GETDATE())"

            gconnection.dataOperation(1, strSQL, "INVENTORYSTOREGROUPMASTER")
        ...
        ElseIf Cmd_Add.Text = "Update[F7]" Then
            ...
            strSQL = "UPDATE  INVENTORYSTOREGROUPMASTER "
            strSQL = strSQL & " SET STOREGROUPdesc='" & Replace(Trim(txt_CATEGORYDesc.Text), "'", "") & "',"
            strSQL = strSQL & " updateUSER='" & Trim(gUsername) & "',UPDATEDATE=GETDATE(),Freeze='N' "
            strSQL = strSQL & " WHERE STOREGROUPcode = '" & Trim(txt_CATEGORYCode.Text) & "' "
    ...
    Private Sub Cmd_Freeze_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Freeze.Click
        ...
        If Mid(Me.Cmd_Freeze.Text, 1, 1) = "V" Then
            sqlstring = "UPDATE  INVENTORYSTOREGROUPMASTER "
            sqlstring = sqlstring & " SET Freeze= 'Y',voiduser='" & gUsername & " ', voiddate=GETDATE() "
            sqlstring = sqlstring & " WHERE STOREGROUPcode = '" & Trim(txt_CATEGORYCode.Text) & "'"
            gconnection.dataOperation(3, sqlstring, "INVENTORYSTOREGROUPMASTER")
        ...
        Else
            ...
            sqlstring = sqlstring & " WHERE STOREGROUPcode = '" & Trim(txt_CATEGORYCode.Text) & "'"
            gconnection.dataOperation(6, sqlstring, "INVENTORYSTOREGROUPMASTER")
    ...
    Private Sub Cmd_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_View.Click
        ...
        If txt_CATEGORYCode.Text.Length > 0 Then
            tables = " FROM INVENTORYSTOREGROUPMASTER WHERE STOREGROUPcode ='" & txt_CATEGORYCode.Text & "' "
        Else
            tables = "FROM INVENTORYSTOREGROUPMASTER "
        End If
        Gheader = "INVENTORYSTOREGROUPMASTER DETAILS"
        ...
        Dim ROW As String() = New String() {"STOREGROUPCODE", "13"}
        FRM.DataGridView1.Rows.Add(ROW)
        ROW = New String() {"STOREGROUPDESC", "30"}
        'FRM.DataGridView1.Rows.Add(ROW)
    ...
    Private Sub Store_Master_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F1 And cmd_rpt.Visible = True Then
            ...
            Exit Sub
        End If
        If e.KeyCode = Keys.F3 And cmd_export.Visible = True Then
    ...
    Private Sub cmdStoreCode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStoreCode.Click
        gSQLString = "SELECT distinct ISNULL(STOREGROUPcode,'') AS STOREGROUPcode,ISNULL(STOREGROUPDESC,'') AS STOREGROUPDESC FROM INVENTORYSTOREGROUPMASTER"
        M_WhereCondition = ""
        Dim vform As New ListOperattion1
        vform.Field = "STOREGROUPDESC,STOREGROUPcode"
        vform.vFormatstring = "         STOREGROUP CODE              |                  STOREGROUP DESCRIPTION                                                                                                   "
        vform.vCaption = "STORE GROUP MASTER HELP"
        vform.KeyPos = 0
        vform.KeyPos1 = 1
        vform.ShowDialog(Me)
    ...
    Private Sub txt_StoreCode_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_CATEGORYCode.Validated
        ...
        If Trim(txt_CATEGORYCode.Text) <> "" Then
            sqlstring = "SELECT ISNULL(STOREGROUPCODE,'') AS STOREGROUPCODE,ISNULL(STOREGROUPDESC,'') AS STOREGROUPDESC,ISNULL(FREEZE,'') AS FREEZE,ADDDATE,voiddate FROM INVENTORYSTOREGROUPMASTER WHERE STOREGROUPCODE='" & Trim(txt_CATEGORYCode.Text) & "'"
            gconnection.getDataSet(sqlstring, "INVENTORYSTOREGROUPMASTER")
            If gdataset.Tables("INVENTORYSTOREGROUPMASTER").Rows.Count > 0 Then
                txt_CATEGORYCode.Text = Trim(gdataset.Tables("INVENTORYSTOREGROUPMASTER").Rows(0).Item("STOREGROUPCODE"))
                txt_CATEGORYDesc.Text = Trim(gdataset.Tables("INVENTORYSTOREGROUPMASTER").Rows(0).Item("STOREGROUPDESC"))
                If gdataset.Tables("INVENTORYSTOREGROUPMASTER").Rows(0).Item("FREEZE") = "Y" Then
                    Me.lbl_Freeze.Visible = True
                    Me.lbl_Freeze.Text = ""
                    Me.lbl_Freeze.Text = "Record Freezed  On " & Format(CDate(gdataset.Tables("INVENTORYSTOREGROUPMASTER").Rows(0).Item("VOIDDATE")), "dd/MMM/yyyy")
                    ' JH
    ...
    Public Sub checkValidation()
        ...
        If Trim(txt_CATEGORYCode.Text) = "" Then
            MessageBox.Show(" Store Group Code can't be blank ", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            txt_CATEGORYCode.Focus()
            Exit Sub
        End If
        '''********** Check  CATEGORY desc Can't be blank *********************'''
        If Trim(txt_CATEGORYDesc.Text) = "" Then
            MessageBox.Show(" Store Group Desc can't be blank ", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            txt_CATEGORYDesc.Focus()
            Exit Sub
        End If
    ...
    Private Sub PRINTOPERATION()
        ...
        Try
            ...
            printfile = VFilePath
            pageno = 1
            sqlstring = "SELECT STOREGROUPCODE,STOREGROUPDESC,FREEZE FROM INVENTORYSTOREGROUPMASTER ORDER BY STOREGROUPCODE"
            gconnection.getDataSet(sqlstring, "INVENTORYSTOREGROUPMASTER")
            Call Print_Headers(PAGEHEADING)
            Filewrite.WriteLine()
            pagesize = pagesize + 1
            For Each dr In gdataset.Tables("INVENTORYSTOREGROUPMASTER").Rows
                Filewrite.WriteLine("|{0,-15}|{1,-40}|{2,10}|", Mid(dr.Item("STOREGROUPCODE"), 1, 15), Mid(dr.Item("STOREGROUPDESC"), 1, 40), Mid(dr.Item("FREEZE"), 1, 10))
                pagesize = pagesize + 1
                If pagesize > 58 Then
    ...
    Private Function Print_Headers(ByVal pageheading() As String)
        ...
        Try
            ...
            Filewrite.WriteLine(StrDup(80, "-"))
            pagesize = pagesize + 1
            Filewrite.WriteLine("|{0,-15}|{1,-40}|{2,10}|", "STOREGROUPCODE", "STORE GROUP DESCRIPTION", "FREEZE")
            pagesize = pagesize + 1
            Filewrite.WriteLine(StrDup(80, "-"))
            pagesize = pagesize + 1
        Catch ex As Exception
    ...
    Private Sub cmd_export_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_export.Click
        ...
        _export.TABLENAME = "inventorySTOREGROUPmaster"
        sqlstring = "select * from inventorySTOREGROUPmaster"
    ...
    Private Sub btn_validation_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        System.Diagnostics.Process.Start(AppPath & "/STUDY/STOREGROUPMASTER.XLS")
    End Sub

    Private Sub cmd_auth_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_auth.Click
        Authocheck("INVENTORY", "STOREGROUP Master", gUsername, "INVENTORYSTOREGROUPMASTER", "STOREGROUPCODE", Me)
    ...
    Private Sub cmd_rpt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_rpt.Click
        ...
        sqlstring = "SELECT DISTINCT  STOREGROUPCODE, STOREGROUPDESC, FREEZE FROM inventorySTOREGROUPmaster order by STOREGROUPCODE  "
        gconnection.getDataSet(sqlstring, "inventorySTOREGROUPmaster")
        If gdataset.Tables("inventorySTOREGROUPmaster").Rows.Count > 0 Then
            If chk_excel.Checked = True Then
                Dim exp As New exportexcel
                exp.Show()
                Call exp.export(sqlstring, "STORE GROUP MASTER ", "")
            Else
                rViewer.ssql = sqlstring
                rViewer.Report = r
                rViewer.TableName = "inventorySTOREGROUPmaster"
                Dim textobj1 As TextObject
