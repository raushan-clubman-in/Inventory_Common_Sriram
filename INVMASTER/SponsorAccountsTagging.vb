Public Class SponsorAccountsTagging
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SponsorAccountsTagging))
        ...
        Me.Label1.Size = New System.Drawing.Size(395, 26)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(27, 117)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(701, 454)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(756, 210)
        ...
        Me.cmdexit.Location = New System.Drawing.Point(6, 64)
        ...
        Me.ssgrid.Location = New System.Drawing.Point(38, 129)
        Me.ssgrid.Name = "ssgrid"
        Me.ssgrid.OcxState = CType(resources.GetObject("ssgrid.OcxState"), System.Windows.Forms.AxHost.State)
        Me.ssgrid.Size = New System.Drawing.Size(671, 427)
        ...
        Me.Label2.Location = New System.Drawing.Point(173, 621)
        ...
        Me.Label3.Location = New System.Drawing.Point(173, 643)
        Me.Label3.Name = "Label3"
        Me.Label3.Size = New System.Drawing.Size(119, 13)
        Me.Label3.TabIndex = 378
        Me.Label3.Text = "Press F8 for Search"
        '
        'SponsorAccountsTagging
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.AutoSize = True
        Me.BackgroundImage = CType(resources.GetObject("$this.BackgroundImage"), System.Drawing.Image)
        Me.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch
        Me.ClientSize = New System.Drawing.Size(920, 730)
        ...
        Me.KeyPreview = True
        Me.Name = "SponsorAccountsTagging"
...
#End Region
    ...
    Private Sub GetRights()
        ...
        Dim chstr As String
        GmoduleName = "SponsorAccountsTagging"
    ...
    Sub bindcodefield()
        Dim sql1 As String = "Select Code,description,accountcode,accountdesc,slcode,sldesc,costcentercode,costcenterdesc from SponsorAccountsTagging where tablename='" & tabname & "' UNION "
        sql1 = sql1 & " SELECT distinct " & CodeField & "," & Codedesc & ",'' AS accountcode,'' AS accountdesc,'' AS slcode,'' AS sldesc,'' AS costcentercode,'' AS costcenterdesc FROM " & tabname & " "
        sql1 = sql1 & " WHERE " & CodeField & " NOT IN (Select Code from SponsorAccountsTagging where tablename='" & tabname & "') and ISNULL(Freeze,'N')<>'Y'"
        'order by " & Codeorderfield

        gconnection.getDataSet(sql1, "SponsorAccountsTagging")
        If gdataset.Tables("SponsorAccountsTagging").Rows.Count > 0 Then
            For i As Integer = 0 To gdataset.Tables("SponsorAccountsTagging").Rows.Count - 1
                With ssgrid
                    .Row = i + 1
                    .Col = 1
                    .Text = gdataset.Tables("SponsorAccountsTagging").Rows(i).Item("Code")

                    .Row = i + 1
                    .Col = 2
                    .Text = gdataset.Tables("SponsorAccountsTagging").Rows(i).Item("description")
                    .Row = i + 1
                    .Col = 3
                    ...
                    .Row = i + 1
                    .Col = 7
                    .Text = gdataset.Tables("SponsorAccountstagging").Rows(i).Item("costcentercode")
                    .Row = i + 1
                    .Col = 8
                    .Text = gdataset.Tables("SponsorAccountstagging").Rows(i).Item("costcenterdesc")
    ...
    Private Sub cmdsave_Click(sender As Object, e As EventArgs) Handles cmdsave.Click
        ...
        For s As Integer = 0 To ssgrid.DataRowCnt - 1
            ssgrid.Row = s + 1
            ssgrid.Col = 1
            Dim sst As String = "select count(*) from SponsorAccountsTagging where code='" + ssgrid.Text + "' and tablename='" + tabname + "'"
            If gconnection.getvalue(sst) = 0 Then
                Sql = "Insert into SponsorAccountstagging(Code,description,accountcode,accountdesc,slcode,sldesc,costcentercode,costcenterdesc,void,tablename,colname) values( "
                Sql = Sql & " '" + ssgrid.Text + "',"
                ssgrid.Row = s + 1
                ssgrid.Col = 2
                Sql = Sql & " '" + ssgrid.Text + "',"
                ...
                Sql = Sql & " '" + CodeField + "')"
            Else
                Sql = "Update SponsorAccountstagging set "
