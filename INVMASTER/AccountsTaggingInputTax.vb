Public Class AccountsTaggingInputTax
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AccountsTaggingInputTax))
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(27, 114)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(602, 406)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(635, 210)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(140, 123)
        ...
        Me.cmdexit.Location = New System.Drawing.Point(9, 63)
        ...
        Me.cmdsave.Location = New System.Drawing.Point(9, 13)
        ...
        Me.ssgrid.Location = New System.Drawing.Point(40, 129)
        Me.ssgrid.Name = "ssgrid"
        Me.ssgrid.OcxState = CType(resources.GetObject("ssgrid.OcxState"), System.Windows.Forms.AxHost.State)
        Me.ssgrid.Size = New System.Drawing.Size(568, 372)
        ...
        Me.Label2.Location = New System.Drawing.Point(127, 535)
        ...
        Me.Label3.Location = New System.Drawing.Point(127, 557)
        Me.Label3.Name = "Label3"
        Me.Label3.Size = New System.Drawing.Size(119, 13)
        Me.Label3.TabIndex = 378
        Me.Label3.Text = "Press F8 for Search"
        '
        'AccountsTaggingInputTax
        '
        ...
        Me.Name = "AccountsTaggingInputTax"
...
#End Region
    ...
    Private Sub Resize_Form()
        ...
        End With
    End Sub
    Private Sub AccountsTagging_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.F7 And cmdsave.Visible = True Then
            Call cmdsave_Click(cmdsave, e)
            Exit Sub
        End If
    ...
    Private Sub AccountsTagging_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim sql As String = "Select taxCode from AccountsTaxMaster where  taxcode='IN_ADDCESS'"
        gconnection.getDataSet(sql, "AccountsTaxMaster")
        If gdataset.Tables("AccountsTaxMaster").Rows.Count = 0 Then
            sql = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccountsTaxMaster' AND  COLUMN_NAME = 'VOID') Begin alter table AccountsTaxMaster add  VOID VARCHAR(30) End"
            gconnection.dataOperation(6, sql, "AddC")
            sql = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccountsTaxMaster' AND  COLUMN_NAME = 'inputtaxaccountinDESC') Begin alter table AccountsTaxMaster add  inputtaxaccountinDESC VARCHAR(30) End"
            gconnection.dataOperation(6, sql, "AddC")
            sql = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccountsTaxMaster' AND  COLUMN_NAME = 'INPUTTAXSLCODEIN') Begin alter table AccountsTaxMaster add  INPUTTAXSLCODEIN VARCHAR(30) End"
            gconnection.dataOperation(6, sql, "AddC")
            sql = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccountsTaxMaster' AND  COLUMN_NAME = 'inputtaxSLDESC') Begin alter table AccountsTaxMaster add  inputtaxSLDESC VARCHAR(30) End"
            gconnection.dataOperation(6, sql, "AddC")

            sql = "INSERT [dbo].[accountstaxmaster] ([taxcode], [taxdesc], [taxpercentage], [typeoftax], [glaccountin], [glaccountdesc], [VOID], [INPUTTAXACCOUNTIN],   [inputtaxaccountinDESC], [INPUTTAXSLCODEIN], [inputtaxSLDESC]) VALUES (N'IN_ADDCESS', N'ADDITIONAL CESS', CAST(0.00 AS Numeric(10, 2)), N'CESS', N'','',    'N','','','','')"
            gconnection.dataOperation(6, sql, "AddC")
        End If

        sql = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccountsTaxMaster' AND  COLUMN_NAME = 'OUTPUTTAXACCOUNTIN') Begin alter table AccountsTaxMaster add  OUTPUTTAXACCOUNTIN VARCHAR(30) End"
        gconnection.dataOperation(6, sql, "AddC")

        sql = "IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccountsTaxMaster' AND  COLUMN_NAME = 'OUTPUTTAXACCOUNTINDESC') Begin alter table AccountsTaxMaster add  OUTPUTTAXACCOUNTINDESC VARCHAR(200) End"
        gconnection.dataOperation(6, sql, "AddC")
    ...
    Sub bindssgrid()
        ...
        With ssgrid
            ...
            .Row = 0
            .Col = 3
            .Text = "INPUTTAXIN ACCOUNT CODE"

            .Row = 0
            .Col = 4
            .Text = "INPUTTAXIN ACCOUNT DESCRIPTION"

            .Row = 0
            .Col = 5
            .Text = "OUTPUTTAX ACCOUNT CODE"


            .Row = 0
            .Col = 6
            .Text = "OUTPUTTAX ACCOUNT DESCRIPTION"
    ...
    Sub bindcodefield()
        Dim sql1 As String = "Select taxCode,taxdesc,isnull(inputtaxaccountin,'') as inputtaxaccountin,isnull(inputtaxaccountinDESC,'') as inputtaxaccountinDESC ,isnull(OUTputtaxaccountin,'') as OUTputtaxaccountin,isnull(OUTputtaxaccountinDESC,'') as OUTputtaxaccountinDESC from AccountsTaxMaster where isnull(inputtaxaccountin,'')<>'' UNION "
        sql1 = sql1 & " SELECT taxCode,taxdesc,isnull(inputtaxaccountin,'') as inputtaxaccountin,isnull(inputtaxaccountinDESC,'') as inputtaxaccountinDESC ,isnull(OUTputtaxaccountin,'') as OUTputtaxaccountin,isnull(OUTputtaxaccountinDESC,'') as OUTputtaxaccountinDESC FROM  AccountsTaxMaster where isnull(inputtaxaccountin,'')='' "
        sql1 = sql1 & " and taxCode NOT IN (Select taxCode from AccountsTaxMaster where isnull(inputtaxaccountin,'')<>'') "
        'order by " & Codeorderfield

        gconnection.getDataSet(sql1, "AccountsTaxMaster")
        If gdataset.Tables("AccountsTaxMaster").Rows.Count > 0 Then

            ssgrid.MaxRows = gdataset.Tables("AccountsTaxMaster").Rows.Count
            For i As Integer = 0 To gdataset.Tables("AccountsTaxMaster").Rows.Count - 1
                With ssgrid
                    .Row = i + 1
                    .Col = 1
                    .Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("taxCode")

                    .Row = i + 1
                    .Col = 2
                    .Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("taxdesc")
                    .Row = i + 1
                    .Col = 3
                    .Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("inputtaxaccountin")
                    .Row = i + 1
                    .Col = 4
                    .Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("inputtaxaccountinDESC")
                    .Row = i + 1
                    .Col = 5
                    .Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("OUTputtaxaccountin")
                    .Row = i + 1
                    .Col = 6
                    .Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("OUTputtaxaccountinDESC")

                    '.Row = i + 1
                    '.Col = 5
                    '.Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("slcode")
                    '.Row = i + 1
                    '.Col = 6
                    '.Text = gdataset.Tables("AccountsTaxMaster").Rows(i).Item("sldesc")
                    '.Row = i + 1
                    '.Col = 7
    ...
    Private Sub cmdsave_Click(sender As Object, e As EventArgs) Handles cmdsave.Click
        ...
        For s As Integer = 0 To ssgrid.DataRowCnt - 1
            ssgrid.Row = s + 1
            ssgrid.Col = 1
            'Dim sst As String = "select count(*) from accountstaxmaster where taxcode='" + ssgrid.Text + "' and isnull(inputtaxaccountin,'')='' "
            'If gconnection.getvalue(sst) = 0 Then
            '    Sql = "Insert into accountstaxmaster(taxCode,taxdescription,glaccountcode,glaccountdesc,slcode,sldesc,void,tablename,colname) values( "
            '    Sql = Sql & " '" + ssgrid.Text + "',"
            '    ssgrid.Row = s + 1
            '    ssgrid.Col = 2
            '    Sql = Sql & " '" + ssgrid.Text + "',"
            ...
            '    Sql = Sql & " 'N',"
            '    Sql = Sql & " '" + tabname + "',"
            '    Sql = Sql & " '" + CodeField + "')"   isnull(inputtaxaccountin,'') as inputtaxaccountin,isnull(inputtaxaccountinDESC,'')
            'Else
            Sql = "Update accountstaxmaster set "
            '(Code,description,accountcode,accountdesc,slcode,sldesc,costcentercode,costcenterdesc,void,tablename,colname) values( "
            ssgrid.Row = s + 1
            ssgrid.Col = 3

            Sql = Sql & "inputtaxaccountin= '" + ssgrid.Text + "',"
            ssgrid.Row = s + 1
            ssgrid.Col = 4
            Sql = Sql & "inputtaxaccountinDESC= '" + ssgrid.Text + "', "

            ssgrid.Row = s + 1
            ssgrid.Col = 5

            Sql = Sql & "OUTputtaxaccountin= '" + ssgrid.Text + "',"
            ssgrid.Row = s + 1
            ssgrid.Col = 6
            Sql = Sql & "OUTputtaxaccountinDESC= '" + ssgrid.Text + "' "
            ...
            Sql = Sql & " where taxCode='" + ssgrid.Text + "'"
