...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ImgQuit2.Location = New System.Drawing.Point(690, 500)
        ...
        Me.ImgQuit2.Visible = False
        '
        'ImgQuit1
        '
        Me.ImgQuit1.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.ImgQuit1.Image = CType(resources.GetObject("ImgQuit1.Image"), System.Drawing.Image)
        Me.ImgQuit1.Location = New System.Drawing.Point(676, 323)
        ...
        'fgrdCompanyList
        '
        Me.fgrdCompanyList.Location = New System.Drawing.Point(80, 192)
        ...
        Me.fgrdCompanyList.Size = New System.Drawing.Size(574, 144)
        Me.fgrdCompanyList.TabIndex = 0
        '
        'ImgPro1
        '
        Me.ImgPro1.Image = CType(resources.GetObject("ImgPro1.Image"), System.Drawing.Image)
        Me.ImgPro1.Location = New System.Drawing.Point(667, 192)
        Me.ImgPro1.Name = "ImgPro1"
        Me.ImgPro1.Size = New System.Drawing.Size(82, 36)
        ...
        Me.ImgPro2.Location = New System.Drawing.Point(667, 192)
        ...
        'ImgDel1
        '
        Me.ImgDel1.BackColor = System.Drawing.Color.Transparent
        Me.ImgDel1.Image = CType(resources.GetObject("ImgDel1.Image"), System.Drawing.Image)
        Me.ImgDel1.Location = New System.Drawing.Point(667, 384)
        Me.ImgDel1.Name = "ImgDel1"
        Me.ImgDel1.Size = New System.Drawing.Size(82, 32)
        Me.ImgDel1.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage
        Me.ImgDel1.TabIndex = 5
        Me.ImgDel1.TabStop = False
        Me.ImgDel1.Visible = False
        '
        'ImgDel2
        '
        ...
        Me.ImgDel2.Visible = False
        '
        'ImgMod1
        '
        Me.ImgMod1.Image = CType(resources.GetObject("ImgMod1.Image"), System.Drawing.Image)
        Me.ImgMod1.Location = New System.Drawing.Point(667, 323)
        Me.ImgMod1.Name = "ImgMod1"
        Me.ImgMod1.Size = New System.Drawing.Size(82, 31)
        Me.ImgMod1.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage
        Me.ImgMod1.TabIndex = 7
        Me.ImgMod1.TabStop = False
        Me.ImgMod1.Visible = False
        '
        'ImgMod2
        '
        ...
        Me.lblAddress1.Location = New System.Drawing.Point(114, 384)
        ...
        Me.lblAddress4.ForeColor = System.Drawing.Color.Black
        Me.lblAddress4.Location = New System.Drawing.Point(114, 464)
        ...
        Me.lblAddress3.Location = New System.Drawing.Point(114, 440)
        ...
        Me.lblAddress2.Location = New System.Drawing.Point(114, 408)
...
#End Region 
    ...
    Private Sub fgrdCompanyList_Click1()
        ...
        '  Dim gFinancialyearStarting As Object
        Dim ADODB As Object
        Dim vDate As Date
        If Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0)) <> "" Then
            ...
            'gFinancialyearStarting = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 1)), "dd/MM/yyyy")
            'gFinancialyearEnding = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 2)), "dd/MM/yyyy")

            gFinancialyearStarting = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 1)), "dd/MMM/yyyy")
            gFinancialyearEnding = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 2)), "dd/MMM/yyyy")

            gFinancialyearStart = Year(gFinancialyearStarting)
            gFinancalyearStart = gFinancialyearStart
            ...
            gCompanyAddress(3) = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 6))
            gCompanyAddress(4) = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 8))
            gCompanyAddress(5) = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 9))
            'End
            '''''''
            Call GET_SERVERTIME()
            If GBL_SERVERTIMETT > gFinancialyearEnding Then
                '' MessageBox.Show("Do you want to save Data in Previous Year...!")
                If MessageBox.Show("Do you want to save Data in Previous Year...!", Question, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
                    'If MsgBox("Do you want to save Data in Previous Year...!", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton2, "CLUB MAN") = MsgBoxResult.Yes Then
                    Me.Hide()
                    If gMDIshown = False Then
            ...
            End If
    End Sub
    Public Sub fgrdCompanyList_KeyPressEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxMSFlexGridLib.DMSFlexGridEvents_KeyPressEvent) Handles fgrdCompanyList.KeyPressEvent
    ...
    Private Sub fgrdCompanyList_RowColChange(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles fgrdCompanyList.RowColChange
        ...
        ' Call ImgPro2_Click(ImgPro2, New System.EventArgs)
    End Sub
    Private Sub CompanyList1_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        SQLSTRING = SQLSTRING & " ISNULL(ADD1,'') AS ADD1,ISNULL(ADD2,'') AS ADD2,ISNULL(CITY,'') AS CITY,ISNULL(STATE,'') AS STATE,ISNULL(PINCODE,'') AS PINCODE,ISNULL(PHONE1,'') AS PHONE1,ISNULL(PHONE2,'') AS PHONE2,ISNULL(FAX,'') AS FAX FROM CLUBMASTER where companyname not like '%PAY%' order by sno"
        ...
        If gdataset.Tables("CLUBMASTER").Rows.Count > 0 Then
            ...
            For LoopIndex = 0 To gdataset.Tables("CLUBMASTER").Rows.Count - 1
                With gdataset.Tables("CLUBMASTER").Rows(LoopIndex)
                    ...
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 1, Format(.Item("FROMDATE"), "dd/MMM/yyyy"))
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 2, Format(.Item("TODATE"), "dd/MMM/yyyy"))
                    ...
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 6, Trim(.Item("STATE")))
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 7, Trim(CStr(.Item("DATAFILE"))))
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 9, Trim(.Item("PHONE1")))
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 8, Trim(.Item("FAX")))
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 8, Trim(.Item("PINCODE")))
                End With
            Next LoopIndex
        End If
    ...
    Private Sub ImgQuit1_Click(sender As Object, e As EventArgs) Handles ImgQuit1.Click
        Application.Exit()
    End Sub
End Class