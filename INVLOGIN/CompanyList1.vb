...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ImgPro1.Location = New System.Drawing.Point(667, 160)
        ...
        Me.ImgPro2.Location = New System.Drawing.Point(667, 160)
        ...
        Me.ImgDel1.Location = New System.Drawing.Point(667, 299)
        ...
        Me.ImgDel2.Location = New System.Drawing.Point(667, 299)
        ...
        Me.ImgMod1.Location = New System.Drawing.Point(667, 250)
        ...
        Me.ImgMod2.Location = New System.Drawing.Point(667, 250)
        ...
        Me.ImgAdd1.Location = New System.Drawing.Point(667, 205)
        ...
        Me.ImgAdd2.Location = New System.Drawing.Point(667, 205)
        ...
        Me.ClientSize = New System.Drawing.Size(837, 600)
        Me.ControlBox = False
...
#End Region 
    ...
    Private Sub fgrdCompanyList_Click1()
        ...
        If Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0)) <> "" Then
            ...
            gstartingdate = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 1)), "dd/MMM/yyyy")
            gstartingdateNew = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 1)), "dd/MMM/yyyy")
            gendingdate = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 2)), "dd/MMM/yyyy")
            gFinancialyearStart = Format(CDate(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 1)), "dd/MMM/yyyy")
            ...
            gCompanyAddress(4) = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 7))
    ...
    Private Sub CompanyList1_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        SQLSTRING = SQLSTRING & " ISNULL(ADD1,'') AS ADD1,ISNULL(ADD2,'') AS ADD2,ISNULL(CITY,'') AS CITY,ISNULL(STATE,'') AS STATE,ISNULL(PINCODE,'') AS PINCODE,ISNULL(PHONE1,'') AS PHONE1,ISNULL(FAX,'') AS FAX FROM CLUBMASTER  ORDER BY SNO"
        gconnection.getCompanyinfo(SQLSTRING, "CLUBMASTER")
        If gdataset.Tables("CLUBMASTER").Rows.Count > 0 Then
    ...
    Private Sub fgrdCompanyList_Enter(sender As Object, e As EventArgs) Handles fgrdCompanyList.Enter
