...
Public Class frmStockSummary_tot
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmStockSummary_tot))
        ...
        Me.lbl_Heading.Size = New System.Drawing.Size(326, 31)
        Me.lbl_Heading.TabIndex = 5
        Me.lbl_Heading.Text = "TOTAL STOCK SUMMARY"
        ...
        Me.lbl_Itemlist.Size = New System.Drawing.Size(336, 24)
        ...
        Me.Chklist_Itemdetails.Size = New System.Drawing.Size(336, 361)
        ...
        Me.dtp_Fromdate.Location = New System.Drawing.Point(144, 24)
        ...
        Me.Cmd_Exit.Location = New System.Drawing.Point(688, 624)
        ...
        Me.CHK_ZEROQTY.Location = New System.Drawing.Point(712, 704)
        ...
        Me.CHK_VALUE.Location = New System.Drawing.Point(568, 704)
        ...
        Me.CHK_ITEMMASTSTK.Location = New System.Drawing.Point(840, 704)
        ...
        Me.grp_orderby.Location = New System.Drawing.Point(632, 472)
        Me.grp_orderby.Name = "grp_orderby"
        Me.grp_orderby.Size = New System.Drawing.Size(216, 56)
        ...
        Me.cmd_itemto.Location = New System.Drawing.Point(400, 16)
        ...
        Me.txt_itemto.Location = New System.Drawing.Point(320, 16)
        Me.txt_itemto.MaxLength = 20
        Me.txt_itemto.Name = "txt_itemto"
        Me.txt_itemto.Size = New System.Drawing.Size(80, 26)
        ...
        Me.TXT_FROM.Size = New System.Drawing.Size(88, 26)
        ...
        Me.Lbl_SubledgerCode.Location = New System.Drawing.Point(8, 16)
        ...
        Me.txt_Mainstore.Location = New System.Drawing.Point(208, 704)
        ...
        Me.lbl_Mainstore.Location = New System.Drawing.Point(8, 704)
        ...
        Me.cmd_storecode.Location = New System.Drawing.Point(184, 704)
        ...
        Me.TXT_MAINSTORECODE.Location = New System.Drawing.Point(120, 704)
        ...
        Me.PictureBox3.Location = New System.Drawing.Point(392, 72)
        Me.PictureBox3.Name = "PictureBox3"
        Me.PictureBox3.Size = New System.Drawing.Size(24, 24)
        Me.PictureBox3.TabIndex = 498
        ...
        Me.Label9.Location = New System.Drawing.Point(416, 72)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(808, 72)
        ...
        Me.Label6.Location = New System.Drawing.Point(832, 72)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(136, 472)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(112, 24)
        Me.PictureBox2.Name = "PictureBox2"
        Me.PictureBox2.Size = New System.Drawing.Size(32, 32)
        Me.PictureBox2.TabIndex = 505
        ...
        Me.KeyPreview = True
        Me.Name = "frmStockSummary_tot"
        Me.Text = "REPORTS [TOTAL STOCK SUMMARY]"
...
#End Region
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Else
            ...
            ElseIf CHK_VALUE.Checked = True Then
                If MsgBox("Click YES for 'Windows View' or NO for 'TEXT View'", MsgBoxStyle.YesNo, " TOTAL STOCK SUMMARY") = MsgBoxResult.Yes Then
    ...
    Public Sub ViewStocksummary()
        Try
            ...
            If gdataset.Tables("STOREMASTER").Rows.Count > 0 Then
                ...
                gcommand = New SqlCommand("CP_STOCKSUMMARY_tot", gconnection.Myconn)
    ...
    Private Sub StkSummary_crystal()
        Try
            ...
            Dim r As New Rpt_stk_summary_total
            ...
            sqlstring = " SELECT ISNULL(STORECODE,'') AS STORECODE FROM STOREMASTER "
            gconnection.getDataSet(sqlstring, "STOREMASTER")
            If gdataset.Tables("STOREMASTER").Rows.Count > 0 Then
                Storecode = gdataset.Tables("STOREMASTER").Rows(0).Item("STORECODE")
                '---------------------- EXECUTE STORE PROCEDURE --------------------------'
                ...
                '--------------------------------------------------------------------------'
            Else
                MessageBox.Show("PLEASE CREATE STORES IN MASTER...", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            sqlstring = " SELECT ISNULL(S.STORECODE,'') AS STORECODE,ISNULL(S.ITEMCODE,'') AS ITEMCODE,ISNULL(S.ITEMNAME,'') AS ITEMNAME,ISNULL(S.UOM,'') AS UOM, ISNULL(I.GROUPNAME,'') AS GROUPNAME,"
            ...
            If CHK_ZEROQTY.Checked = False Then
                sqlstring = sqlstring & " And (OPQTY <> 0 OR RCVQTY <> 0 OR ISSQTY <> 0)"
            End If
            sqlstring = sqlstring & " AND OPQTY > 0 GROUP BY ISNULL(S.STORECODE,''),ISNULL(S.ITEMCODE,''),ISNULL(S.ITEMNAME,''),ISNULL(S.UOM,''), ISNULL(I.GROUPNAME,'') , ISNULL(S.ISSRATE,0) , ISNULL(S.RCVRATE,0) ORDER BY  "
            If rdo_code.Checked = True Then
                sqlstring = sqlstring & " ITEMCODE   "
            Else
                sqlstring = sqlstring & " ITEMNAME "
