...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lbl_Heading.Size = New System.Drawing.Size(254, 29)
        ...
        'lbl_sec2
        '
        Me.lbl_sec2.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'lbl_sec1
        '
        Me.lbl_sec1.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#End Region
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        If Cmd_Add.Text = "Save[F7]" Then
            ...
            strSQL = strSQL & " VALUES (getdate(),'" & MyCompanyName & "','" & gShortName & "','" & GModule & "','" & Format(dtLastWriteTime, "dd/MMM/yyyy") & "'," & FileSize & ",'" & txt_Developername.Text & "','" & txt_ImplementorName.Text & "','" & Txt_DocNo.Text & "','" & Format(Dtp_DocDate.Value, "dd/MMM/yyyy") & "','" & Trim(Txt_ListofChanges.Text) & "')"
    ...
    Private Sub Version_Master_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '    Dim sql As String
        '    sql = "select * FROM Master..CLUBMANVERSION Where ModuleName='SMARTCARD' AND DATEOFVERSION='" & Format(dtCreationDate, "dd/MMM/yyyy") & "' AND SizeofVersion=" & FileSize
