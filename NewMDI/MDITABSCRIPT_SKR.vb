...
Public Class MDITABSCRIPT_SKR
    ...
    Private Sub MasterToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MasterToolStripMenuItem.Click
        Master_submenu.Visible = True
        Trans_submenu.Visible = False
        Report_submenu.Visible = False
    End Sub

    Private Sub TransationsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TransationsToolStripMenuItem.Click
        ' MenuStrip1.Visible = False
    End Sub

    Private Sub ReportsToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles ReportsToolStripMenuItem1.Click
        Master_submenu.Visible = False
        Trans_submenu.Visible = True
        Report_submenu.Visible = False
    End Sub

    Private Sub ToolStripMenuItem2_Click_1(sender As Object, e As EventArgs)
        Try
            'GmoduleName = "MEMBERS SETUP"
            If (ActiveMdiChild IsNot Nothing) Then
                ActiveMdiChild.Close()
            End If
            '  ToolStrip1.Visible = True
            ToolStripButton1.Visible = True
            ToolStripButton1.Text = GmoduleName
            ...
            '   Me.PictureBox2.Image = CType(Member.My.Resources.Resources.date_and_time_setup_icon_vector_6533005, Image)
    ...
    Private Sub Resize_Form()
        ...
        End With
    End Sub
    Private Sub MDITABSCRIPT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MdiParentObj = Me

        lbl_club_name.Visible = False

        Dim mdi As New Main_MDI
        ' mdi.Form1_Load(sender, e)
        lbl_club_name.Text = gcompanyname

        lbl_club_name.Visible = True
    ...
    End Sub
    Private Sub MEMBERSSETUP_Click(sender As Object, e As EventArgs) Handles INVENTORYSETUP.Click
        Try
            If (ActiveMdiChild IsNot Nothing) Then
                ActiveMdiChild.Close()
            End If
    ...
    Private Sub Mclear_Click(sender As Object, e As EventArgs) Handles Mclear.Click
        If subform = "" Then
        Else
            Mbutton.CmdClear_Click(sender, e)
        End If
    End Sub

    Private Sub Msave_Click(sender As Object, e As EventArgs) Handles Msave.Click
        If subform = "" Then
        Else
            Mbutton.CmdAdd_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub UtilityToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UtilityToolStripMenuItem.Click
        Master_submenu.Visible = False
        Trans_submenu.Visible = False
        Report_submenu.Visible = True
    End Sub

    Private Sub CATEGORYMASTER_MouseDown(sender As Object, e As MouseEventArgs) Handles CATEGORYMASTER.MouseDown
        'If e.Button = Windows.Forms.MouseButtons.Left Then
        '    CATEGORYMASTER.Show(Button1, e.Location)
        'End If
    End Sub

    Private Sub COUNTRYMASTER_Click(sender As Object, e As EventArgs) Handles STOREMASTER.Click
        GmoduleName = "COUNTRY MASTER"
        If (ActiveMdiChild IsNot Nothing) Then
            ActiveMdiChild.Close()
        End If
        Try
            Dim OUTSTAND As New frm_mkga_countrymaster_New_UI

            lbl_formname.Text = GmoduleName
            lbl_formname.Visible = True
    ...
    Private Sub MDITABSCRIPT_SKR_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Application.Exit()
    End Sub
    ...
    Private Sub AdministratorToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles AdministratorToolStripMenuItem1.Click
