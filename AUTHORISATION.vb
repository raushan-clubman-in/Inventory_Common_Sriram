...
Public Class AUTHORISATION
    ...
    Public Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        End With
    End Sub
    Public Function exportnew(ByRef dgv As DataGridView, ByVal Path As String) As Boolean
        Dim i, j As Integer
        ...
        Dim ColNames As Generic.List(Of String) = (From col As DataGridViewColumn _
                                           In dgv.Columns.Cast(Of DataGridViewColumn)()
    ...
    Public Sub AUTHORISATION_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load

    End Sub
    Public Sub LOADGRID(ByVal DC As DataTable, ByVal DET As Boolean, ByVal FORMNM As Form, ByVal SQL As String, ByVal KEYFILD As String, ByVal auth As Integer, ByVal LEVEL As Integer, ByVal COLUMSEQ As Integer, Optional ByVal multiyn As Char = "N", Optional ByVal MultiTbl() As String = Nothing)
        LD = False
        DETAIL = DET
        SSQL = SQL
        KEYFIELD = KEYFILD
    ...
    Public Sub DTAUTH_CellContentClick(ByVal sender As Object, ByVal e As DataGridViewCellEventArgs) Handles DTAUTH.CellContentClick
