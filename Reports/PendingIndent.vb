...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lbl_Heading.Size = New System.Drawing.Size(365, 29)
        ...
        Me.Chk_SelectAllStore.Location = New System.Drawing.Point(200, 72)
        ...
        Me.chklst_Store.Location = New System.Drawing.Point(200, 120)
        ...
        Me.ProgressBar1.Size = New System.Drawing.Size(720, 32)
        ...
        Me.PictureBox4.Location = New System.Drawing.Point(472, 24)
        ...
        Me.Cmd_Print.Location = New System.Drawing.Point(600, 632)
        ...
        Me.Cmd_Exit.Location = New System.Drawing.Point(744, 632)
        ...
        Me.Cmd_Clear.Location = New System.Drawing.Point(184, 632)
        ...
        Me.frmbut.Location = New System.Drawing.Point(160, 616)
        ...
        Me.grp_PENDING.Location = New System.Drawing.Point(488, 488)
        Me.grp_PENDING.Name = "grp_PENDING"
        Me.grp_PENDING.Size = New System.Drawing.Size(336, 48)
        ...
        Me.rdo_name.Location = New System.Drawing.Point(8, 24)
        Me.rdo_name.Name = "rdo_name"
        Me.rdo_name.Size = New System.Drawing.Size(160, 16)
        ...
        Me.rdo_indent.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.rdo_indent.Location = New System.Drawing.Point(200, 24)
        ...
        Me.CHK_INDITEM.Location = New System.Drawing.Point(856, 400)
        ...
        Me.Label2.Location = New System.Drawing.Point(552, 96)
        ...
        Me.Chk_SelectAllSupplier.Location = New System.Drawing.Point(552, 72)
        ...
        Me.chklst_Supplier.Location = New System.Drawing.Point(552, 120)
        Me.chklst_Supplier.Name = "chklst_Supplier"
        Me.chklst_Supplier.Size = New System.Drawing.Size(272, 361)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(416, 96)
        ...
        Me.PictureBox3.Location = New System.Drawing.Point(768, 96)
        ...
        Me.Label8.Location = New System.Drawing.Point(440, 96)
        ...
        Me.Label3.Location = New System.Drawing.Point(792, 96)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(160, 488)
        ...
        Me.grp_orderby.Location = New System.Drawing.Point(840, 480)
        ...
        Me.chk_excel.Location = New System.Drawing.Point(316, 16)
...
#End Region
    ...
    Private Sub Print_Indent()
        ...
        If rdo_indent.Checked = True And CHK_INDITEM.Checked = False Then
            ...
            If rdo_code.Checked = True Then
                sqlstring = sqlstring & " order by storelocationname , Indent_date, Itemcode "
            ElseIf rdo_name.Checked = True Then
                sqlstring = sqlstring & " order by storelocationname , indent_date, Itemname "
            Else
            ...
            If gdataset.Tables("Inv_view_Pending_Indent").Rows.Count > 0 Then
                If chk_excel.Checked = True Then
                    ...
                    exp.Show()
                    Call exp.export(sqlstring, "PENDING INDENT " & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "TO" & Format(dtp_Todate.Value, "dd-MMM-yyyy"), "")
                Else
            ...
            Else
                ...
                End If
            ElseIf rdo_indent.Checked = True And CHK_INDITEM.Checked = True Then

            sqlstring = " select indentno,itemcode,qty,(IND_QTY-QTY)AS QTY1,IND_QTY,UOM,STORELOCATIONCODE,OPSTORELOCATIONCODE "
            sqlstring = sqlstring & " from stockissuedetail where qty<>ind_qty and void <> 'Y' "
            If chklst_Store.CheckedItems.Count <> 0 Then
                sqlstring = sqlstring & " AND ISNULL(Storelocationname,'') IN ("
                For i = 0 To chklst_Store.CheckedItems.Count - 1
                    If i = 0 Then
            ...
            Else
                ...
                Exit Sub
            End If
            sqlstring = sqlstring & "  AND ISNULL(STORELOCATIONCODE,'') ='" & Trim(Mid(cbo_Storelocation.Text, 1, 3)) & "'"
            sqlstring = sqlstring & " AND CAST(Convert(varchar(11),DOCDATE,6) AS DATETIME) BETWEEN "
            sqlstring = sqlstring & " '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' AND '" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "'  and isnull(indentno,'')<>''   group by indentno ,itemcode,qty,"
            sqlstring = sqlstring & " UOM,STORELOCATIONCODE,OPSTORELOCATIONCODE,IND_QTY "
            If rdo_code.Checked = True Then
                sqlstring = sqlstring & " order by STORELOCATIONCODE , indentno, Itemcode "
            ElseIf rdo_name.Checked = True Then
                sqlstring = sqlstring & " order by STORELOCATIONCODE , indentno, Itemname "
            Else
            ...
            If gdataset.Tables("stockissuedetail").Rows.Count > 0 Then
                ...
                Else
                    rViewer.ssql = sqlstring
                    rViewer.Report = r
                    rViewer.TableName = "stockissuedetail"
            ...
            If gdataset.Tables("Inv_view_Pending_Pur").Rows.Count > 0 Then
                ...
                Else
                    ...
                    TXTOBJ2 = r.ReportDefinition.ReportObjects("Text21")
