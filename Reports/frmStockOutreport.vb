...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmStockOutreport))
        ...
        Me.lbl_Heading.Location = New System.Drawing.Point(336, 32)
        Me.lbl_Heading.Name = "lbl_Heading"
        Me.lbl_Heading.Size = New System.Drawing.Size(277, 29)
        Me.lbl_Heading.TabIndex = 23
        Me.lbl_Heading.Text = "STOCK OUT REGISTER"
        ...
        Me.Label4.Location = New System.Drawing.Point(304, 96)
        ...
        Me.Chk_SelectAllStore.Location = New System.Drawing.Point(304, 72)
        ...
        Me.chklst_Store.Location = New System.Drawing.Point(304, 120)
        ...
        Me.grp_SalebillChecklist.Location = New System.Drawing.Point(136, 520)
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(136, 520)
        ...
        Me.Cmd_Print.Location = New System.Drawing.Point(488, 608)
        ...
        Me.Cmd_View.Location = New System.Drawing.Point(272, 608)
        ...
        Me.Cmd_Clear.Location = New System.Drawing.Point(152, 608)
        ...
        Me.frmbut.Location = New System.Drawing.Point(136, 592)
        ...
        Me.Cmd_Exit.Location = New System.Drawing.Point(728, 608)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(584, 96)
        ...
        Me.Label8.Location = New System.Drawing.Point(608, 96)
        ...
        Me.grp_orderby.Location = New System.Drawing.Point(736, 456)
        Me.grp_orderby.Name = "grp_orderby"
        Me.grp_orderby.Size = New System.Drawing.Size(112, 64)
        Me.grp_orderby.TabIndex = 501
...
#End Region
    ...
    Private Sub frmStockOutreport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call FillStorename()
    ...
    Private Sub ViewStockInOutregister()
        Try
            ...
            Else
                ...
                Exit Sub
            End If
            sqlstring = sqlstring & " AND ISNULL(DOCTYPE,'') = 'OUT' AND DOCDATE BETWEEN"
            ...
            If gdataset.Tables("VIEWSTOCKREGISTER").Rows.Count > 0 Then
                If chk_excel.Checked = True Then
                    ...
                    exp.Show()
                    Call exp.export(sqlstring, "STOCK OUT REPORT " & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "TO" & Format(dtp_Todate.Value, "dd-MMM-yyyy"), "")
                Else
    ...
    Private Sub frmStockOutreport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub FillStorename()
        Dim i As Integer
        chklst_Store.Items.Clear()
        Sqlstring = "SELECT DISTINCT ISNULL(STOREDESC,'') AS STOREDESC FROM STOCKINOUTDETAIL WHERE ISNULL(DOCTYPE,'') = 'OUT' ORDER BY STOREDESC"
    ...
    Private Sub btn_validation_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_validation.Click
        System.Diagnostics.Process.Start(AppPath & "/STUDY/STOCKOUTREGISTER.XLS")
    End Sub
End Class
