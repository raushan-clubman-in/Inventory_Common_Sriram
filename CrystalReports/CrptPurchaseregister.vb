...
Public Class CrptPurchaseregister
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CrptPurchaseregister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptPurchaseregister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptPurchaseregister = New CrptPurchaseregister
        rpt.Site = Me.Site
        Return rpt
    End Function
