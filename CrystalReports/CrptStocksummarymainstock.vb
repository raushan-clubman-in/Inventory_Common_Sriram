...
Public Class CrptStocksummarymainstock
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CrptStocksummarymainstock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptStocksummarymainstock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptStocksummarymainstock = New CrptStocksummarymainstock
        rpt.Site = Me.Site
        Return rpt
    End Function
