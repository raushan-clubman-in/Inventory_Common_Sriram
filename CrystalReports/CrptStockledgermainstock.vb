...
Public Class CrptStockledgermainstock
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CrptStockledgermainstock.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Calbalance As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedCrptStockledgermainstock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptStockledgermainstock = New CrptStockledgermainstock
        rpt.Site = Me.Site
        Return rpt
    End Function
