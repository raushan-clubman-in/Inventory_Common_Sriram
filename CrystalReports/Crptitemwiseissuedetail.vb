...
Public Class Crptitemwiseissuedetail
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "Crptitemwiseissuedetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptitemwiseissuedetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptitemwiseissuedetail = New Crptitemwiseissuedetail
        rpt.Site = Me.Site
        Return rpt
    End Function
