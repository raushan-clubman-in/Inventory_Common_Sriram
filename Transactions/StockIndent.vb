...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(StockIndent))
        ...
        Me.lbl_Suppliercode.Location = New System.Drawing.Point(103, 20)
        ...
        Me.frmbut.Location = New System.Drawing.Point(862, 118)
        Me.frmbut.Name = "frmbut"
        Me.frmbut.Size = New System.Drawing.Size(148, 518)
        ...
        Me.cmd_Exit.Location = New System.Drawing.Point(9, 436)
        ...
        Me.dtp_Indentdate.Location = New System.Drawing.Point(516, 15)
        ...
        Me.lbl_Heading.Location = New System.Drawing.Point(181, 79)
        Me.lbl_Heading.Name = "lbl_Heading"
        Me.lbl_Heading.Size = New System.Drawing.Size(91, 15)
        Me.lbl_Heading.TabIndex = 21
        Me.lbl_Heading.Text = "STOCK INDENT"
        ...
        Me.lbl_Grndate.Location = New System.Drawing.Point(392, 17)
        ...
        Me.lbl_Grnno.Location = New System.Drawing.Point(87, 53)
        Me.lbl_Grnno.Name = "lbl_Grnno"
        Me.lbl_Grnno.Size = New System.Drawing.Size(90, 15)
        ...
        Me.grp_Grngroup1.Location = New System.Drawing.Point(184, 108)
        Me.grp_Grngroup1.Name = "grp_Grngroup1"
        Me.grp_Grngroup1.Size = New System.Drawing.Size(668, 126)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(480, 11)
        ...
        Me.txt_storecode.Location = New System.Drawing.Point(187, 50)
        ...
        Me.TXT_FROMSTORECODE.Location = New System.Drawing.Point(187, 87)
        ...
        Me.txt_FromStorename.Location = New System.Drawing.Point(262, 85)
        ...
        Me.cmd_fromStorecodeHelp.Location = New System.Drawing.Point(236, 83)
        ...
        Me.cmd_storecode.Location = New System.Drawing.Point(236, 48)
        ...
        Me.txt_storeDesc.Location = New System.Drawing.Point(262, 50)
        ...
        Me.ssgrid.Location = New System.Drawing.Point(184, 240)
        Me.ssgrid.Name = "ssgrid"
        Me.ssgrid.OcxState = CType(resources.GetObject("ssgrid.OcxState"), System.Windows.Forms.AxHost.State)
        Me.ssgrid.Size = New System.Drawing.Size(662, 270)
        ...
        Me.txt_Totalamount.Location = New System.Drawing.Point(741, 516)
        ...
        Me.txt_qty.Location = New System.Drawing.Point(636, 516)
        ...
        Me.grp_footer.Location = New System.Drawing.Point(159, 248)
        ...
        Me.Label10.Location = New System.Drawing.Point(244, 547)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(243, 569)
        Me.GroupBox4.Name = "GroupBox4"
        Me.GroupBox4.Size = New System.Drawing.Size(520, 64)
...
#End Region
            ...
            If Mid(Me.Cmd_FREEZE.Text, 1, 1) = "V" Then
                ...
                For i = 1 To ssgrid.DataRowCnt
                    With ssgrid
                        ...
                        Sqlstring = Sqlstring & " FREEZEDATEtime ='" & Format(Now, "dd-MMM-yyyy") & "'"
                        Sqlstring = Sqlstring & " WHERE INDENT_NO = '" & Trim(txt_IndentNo.Text) & "'"
    ...
    Private Sub ssgrid_KeyDownEvent(ByVal sender As Object, ByVal e As AxFPSpreadADO._DSpreadEvents_KeyDownEvent) Handles ssgrid.KeyDownEvent
        ...
        Dim Rate, clsquantity, AMOUNT, purrate, conv As Double
        Dim Itemcode, Itemdesc As String

        Dim ICODE, STOCKUOM As String
        Dim PRATE, SALERATE As Double
                        ...
                        If Val(temp) = 0 Then
                            ...
                            Else
                                ...
                                If gdataset.Tables("INVENTORYITEMMASTER1").Rows.Count > 0 Then
                                    ...
                                    '-------------16/NOV/2013-----------------
                                    ICODE = Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("ITEMCODE"))
                                    STOCKUOM = getUOmCode(Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("STOCKUOM")))
                                    PRATE = Val(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("PURCHASERATE"))
                                    SALERATE = Val(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("SALERATE"))
                                    '------------------------------
                                    ...
                                    ssgrid.SetText(5, i, Val(purchaserate)) 'ssgrid.Col = 3
                                    'ssgrid.Row = i
                                    'ssgrid.TypeComboBoxString = Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("STOCKUOM"))
                                    'ssgrid.Text = Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("STOCKUOM"))
                                    'If gsalerate = "Y" Then
                                    ...
                                    '    Avgrate = CALWAR(Format(CDate("01/04/" & gFinancalyearStart), "dd MMM yyyy"), Format(dtp_Indentdate.Value, "dd MMM yyyy"), Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("ITEMCODE")), Trim(TXT_FROMSTORECODE.Text))
                                    ...
                                    ssgrid.Col = 3
                                    ssgrid.Row = ssgrid.ActiveRow
                                    STRITEMUOM = getUOmCode(ssgrid.Text)
                                    ...
                                    clsquantity = gconnection.closing(Format(CDate(dtp_Indentdate.Value), "dd/MMM/yyyy"), Itemcode, Trim(TXT_FROMSTORECODE.Text), Trim(STRITEMUOM))
                                    ...
                                    '------****commented by GANESH on 16/11/2013 to get convertion rate----
                                    ...
                                    'If gsalerate = "Y" Then
                                    '    SALERATE = GetGRNUomSaleRate(ICODE, dtp_Indentdate.Value, STRITEMUOM)
                                    '    If SALERATE > 0 Then
                                    '        ssgrid.SetText(5, i, Trim(SALERATE))
                                    '    Else
                                    '        SALERATE = GetInvUomSaleRate(ICODE, dtp_Indentdate.Value, STRITEMUOM, TXT_FROMSTORECODE.Text)
                                    '        ssgrid.SetText(5, i, Trim(SALERATE))
                                    '    End If
                                    ...
                                    'Else
                                    '    'ssgrid.SetText(5, i, Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("PURCHASERATE")))
                                    '    purrate = GetGRNUomRate(ICODE, dtp_Indentdate.Value, STRITEMUOM)
                                    '    ssgrid.Col = 5
                                    '    ssgrid.Row = ssgrid.ActiveRow
                                    '    If purrate > 0 Then
                                    '        ssgrid.Text = Format(Val(purrate), "0.00")
                                    '    Else
                                    '        purrate = GetInvUomRate(ICODE, dtp_Indentdate.Value, STRITEMUOM, TXT_FROMSTORECODE.Text)
                                    '        ssgrid.Text = Format(Val(purrate), "0.00")
                                    '    End If
                                    '    '------*added to stop entry of such items where UOM convertion factor is not found. 
                                    '    If boolConv = False Then
                    ...
                    If ssgrid.Lock = False Then
                        ...
                        Else
                            ...
                            If gdataset.Tables("INVENTORYITEMMASTER1").Rows.Count > 0 Then
                                ...
                                '------XXXX UPDATED BY GANESH ON 15/NOV/2013 FOR ADDING CONVERTION FACTOR xxxxx--------
                                ...
                                If Trim(txt_storecode.Text) <> "" Then
                                    clsquantity = gconnection.closing(Format(CDate(dtp_Indentdate.Value), "dd/MMM/yyyy"), Itemcode, Trim(TXT_FROMSTORECODE.Text), Trim(transuom))
    ...
    Private Sub FillMenuNew()
        Try
            Dim Avgrate, clsquantity, PURCHASERATE, conv As Double
            Dim K As Integer
            ...
            If Trim(vform.keyfield & "") <> "" Then
                ...
                'End If
                Dim transuom As String = ssgrid.Text
                conv = changerate(transuom, Trim(vform.keyfield))
                Dim purchaserate1 As Double = Format(Val(Trim(vform.keyfield5)), "0.00")
                purchaserate = purchaserate / conv
                '  ssgrid.SetText(3, i, Trim(gdataset.Tables("INVENTORYITEMMASTER1").Rows(j).Item("STOCKUOM")))

                ssgrid.SetText(5, i, Val(purchaserate1))
                ...
                Dim INDDATE As Date
                INDDATE = Format(CDate(dtp_Indentdate.Value), "dd-MMM-yyyy")
                Dim cls As Double = gconnection.closing(Format(CDate(dtp_Indentdate.Value), "dd/MMM/yyyy"), Trim(vform.keyfield), Trim(TXT_FROMSTORECODE.Text), Trim(transuom))

                '    clsquantity = ClosingQuantity_Date(Trim(vform.keyfield), Trim(TXT_FROMSTORECODE.Text), STRITEMUOM, INDDATE)
                ssgrid.SetText(7, ssgrid.ActiveRow, Format(Val(cls), "0.000"))
                If Val(clsquantity) <= 0 Then
                    MsgBox("Item Has No Stock", MsgBoxStyle.Information, MyCompanyName)
                    ssgrid.SetActiveCell(1, ssgrid.ActiveRow)
                    ssgrid.Text = ""
                ...
                ''***************** Venu 23August2011
                '---------commented by ganesh on 16/11/2013 to get uom convertion rate---------------
                'Dim grndate1 As DateTime
                'Dim curuom As String
                'Dim currate, prate As Double
                ...
                'If gsalerate = "Y" Then
                '    currate = GetGRNUomSaleRate(Trim(vform.keyfield), dtp_Indentdate.Value, curuom)
                '    If currate > 0 Then
                '        ssgrid.Col = 5
                '        ssgrid.Row = ssgrid.ActiveRow
                '        ssgrid.Text = Format(Val(currate), "0.00")
                '    Else
                '        currate = GetInvUomSaleRate(Trim(vform.keyfield), dtp_Indentdate.Value, curuom, Trim(TXT_FROMSTORECODE.Text))
                '        ssgrid.Col = 5
                '        ssgrid.Row = ssgrid.ActiveRow
                '        ssgrid.Text = Format(Val(currate), "0.00")
                '    End If
                ...
                '    End If
                'Else
                '    currate = GetGRNUomRate(Trim(vform.keyfield), dtp_Indentdate.Value, curuom)
                '    If currate > 0 Then
                '        ssgrid.Col = 5
                '        ssgrid.Row = ssgrid.ActiveRow
                '        ssgrid.Text = Format(Val(currate), "0.00")
                '    Else
                '        currate = GetInvUomRate(Trim(vform.keyfield), dtp_Indentdate.Value, curuom, Trim(TXT_FROMSTORECODE.Text))
                '        ssgrid.Col = 5
                '        ssgrid.Row = ssgrid.ActiveRow
                '        ssgrid.Text = Format(Val(currate), "0.00")
                '    End If
    ...
    Private Function fillmenu()
        ...
        If Trim(vform.keyfield & "") <> "" Then
            ...
            ssgrid.Row = ssgrid.ActiveRow
            If CHK_WAR.Checked = True Then
                Avgrate = CALWAR(Format(CDate("01/04/" & gFinancalyearStart), "dd MMM yyyy"), Format(dtp_Indentdate.Value, "dd MMM yyyy"), Trim(vform.keyfield), Trim(TXT_FROMSTORECODE.Text))
                sqlstring = "SELECT CLSQTY,CLSVAL,CLSRATE FROM STOCKSUMMARY WHERE ITEMCODE='" & Trim(vform.keyfield) & "'"
                gconnection.getDataSet(sqlstring, "RATE")
                If gdataset.Tables("RATE").Rows.Count > 0 Then
                    If Val(gdataset.Tables("RATE").Rows(0).Item("CLSQTY")) > 0 And Val(gdataset.Tables("RATE").Rows(0).Item("CLSVAL")) > 0 Then
    ...
    Private Sub CMD_AUTH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_AUTH.Click
        ...
        End If
        If USERT = 1 Then
            SSQLSTR2 = " SELECT * FROM INVENTORY_INDENTDET WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER1,'')=''"
                ...
                If gdataset.Tables("AUTHORIZE").Rows.Count > 0 Then
                    ...
                    If gdataset.Tables("AUTHORIZELEVEL").Rows.Count > 0 Then
                        ...
                        If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                            ...
                            Call VIEW1.LOADGRID(gdataset.Tables("AUTHORIZEL"), False, Me, "UPDATE INVENTORY_INDENTDET set  ", "indent_no", gdataset.Tables("AUTHORIZELEVEL").Rows(0).Item("AUTHORIZELEVEL"), 1, 1)
                        End If
                    Else
            ...
            End If
        ElseIf USERT = 2 Then
            SSQLSTR2 = " SELECT * FROM INVENTORY_INDENTDET  WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER2,'')='' AND ISNULL(AUTHORISE_USER1,'')<>''"
            gconnection.getDataSet(SSQLSTR2, "AUTHORIZEL")
            If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                gSQLString = "  SELECT * FROM AUTHORIZE WHERE MODULENAME='MEMBER APPLICATION' AND FORMNAME='" & GmoduleName & "' AND '" & gUsername & "' IN(SELECT AUTH2USER1 FROM AUTHORIZE  WHERE MODULENAME='MEMBER APPLICATION' AND FORMNAME='" & GmoduleName & "' UNION ALL SELECT AUTH2USER2 FROM AUTHORIZE WHERE MODULENAME='MEMBER APPLICATION' AND FORMNAME='" & GmoduleName & "')"
                ...
                If gdataset.Tables("AUTHORIZE1").Rows.Count > 0 Then
                    ...
                    If gdataset.Tables("AUTHORIZELEVEL").Rows.Count > 0 Then
                        ...
                        If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                            ...
                            Call VIEW1.LOADGRID(gdataset.Tables("AUTHORIZEL"), False, Me, "UPDATE INVENTORY_INDENTDET set  ", "indent_no", gdataset.Tables("AUTHORIZELEVEL").Rows(0).Item("AUTHORIZELEVEL"), 2, 1)
                        End If
                    End If
                End If
            End If
        ElseIf USERT = 3 Then
            SSQLSTR2 = " SELECT * FROM INVENTORY_INDENTDET WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER3,'')=''AND ISNULL(AUTHORISE_USER1,'')<>''  AND ISNULL(AUTHORISE_USER2,'')<>''"
            gconnection.getDataSet(SSQLSTR2, "AUTHORIZEL")
            If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                gSQLString = "  SELECT * FROM AUTHORIZE WHERE MODULENAME='MEMBER APPLICATION' AND FORMNAME='" & GmoduleName & "' AND '" & gUsername & "' IN(SELECT AUTH3USER1 FROM AUTHORIZE  WHERE MODULENAME='MEMBER APPLICATION' AND FORMNAME='" & GmoduleName & "' UNION ALL SELECT AUTH3USER2 FROM AUTHORIZE WHERE MODULENAME='MEMBER APPLICATION' AND FORMNAME='" & GmoduleName & "')"
                ...
                If gdataset.Tables("AUTHORIZE2").Rows.Count > 0 Then
                    ...
                    gconnection.getDataSet(gSQLString, "AUTHORIZELEVEL")
                    If gdataset.Tables("AUTHORIZELEVEL").Rows.Count > 0 Then
                        SSQLSTR2 = " SELECT * FROM INVENTORY_INDENTDET  WHERE ISNULL(AUTHORISED,'')<>'Y' AND ISNULL(AUTHORISE_USER3,'')=''"
                        gconnection.getDataSet(SSQLSTR2, "AUTHORIZEL")
                        If gdataset.Tables("AUTHORIZEL").Rows.Count > 0 Then
                            Dim VIEW1 As New AUTHORISATION
                            VIEW1.Show()
                            VIEW1.DTAUTH.DataSource = Nothing
                            VIEW1.DTAUTH.Rows.Clear()
                            Call VIEW1.LOADGRID(gdataset.Tables("AUTHORIZEL"), False, Me, "UPDATE INVENTORY_INDENTDET set  ", "indent_no", gdataset.Tables("AUTHORIZELEVEL").Rows(0).Item("AUTHORIZELEVEL"), 3, 1)
                        End If
                    End If
                End If
            Else
