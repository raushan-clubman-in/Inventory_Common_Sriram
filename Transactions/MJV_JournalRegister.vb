...
Imports System.IO
Public Class MJV_JournalRegister
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(MJV_JournalRegister))
        ...
        Me.Dtp_ToVoucherDate.Location = New System.Drawing.Point(304, 88)
        ...
        Me.Dtp_FromVoucherDate.Location = New System.Drawing.Point(120, 88)
        ...
        Me.Label2.Location = New System.Drawing.Point(272, 89)
        ...
        Me.Label10.Size = New System.Drawing.Size(429, 31)
        Me.Label10.TabIndex = 123
        Me.Label10.Text = "MONTH BILL JOURNAL REGISTER"
        '
        'ssGrid
        '
        ...
        Me.Grp_AccountPosting.Location = New System.Drawing.Point(16, 64)
        ...
        Me.GrdAuditTrail.Location = New System.Drawing.Point(8, 40)
        ...
        Me.PictureBox2.Size = New System.Drawing.Size(136, 48)
        ...
        Me.KeyPreview = True
        Me.Name = "MJV_JournalRegister"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "MJV_JournalRegister"
...
#End Region
    Private Sub MJV_JournalRegister_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Show()
    ...
    Private Sub MJV_JournalRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub GridOperation()
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            strsql = "EXEC MJV_POSTING " & "'" & Format(Dtp_FromVoucherDate.Value, "dd-MMM-yyyy") & "','" & Format(Dtp_ToVoucherDate.Value, "dd-MMM-yyyy") & "','T'"
    ...
    Private Sub CMD_POST_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_POST.Click
        Try
            ...
            Dim STRSQL As String
            Me.Cursor = Cursors.WaitCursor
            STRSQL = "EXEC MJV_POSTING " & "'" & Format(Dtp_FromVoucherDate.Value, "dd-MMM-yyyy") & "','" & Format(Dtp_ToVoucherDate.Value, "dd-MMM-yyyy") & "','P'"
            VCONN.dataOperation(6, strsql, "ACCOUNTPOSTING")
            Me.Cursor = Cursors.Default
