...
Imports System.IO
Public Class GRN_Cum_Purchase_Bill_CSC_PO
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GRN_Cum_Purchase_Bill_CSC_PO))
        ...
        Me.lbl_Creditdays.Location = New System.Drawing.Point(784, 162)
        ...
        Me.ssgrid.Location = New System.Drawing.Point(0, 312)
        Me.ssgrid.Name = "ssgrid"
        Me.ssgrid.OcxState = CType(resources.GetObject("ssgrid.OcxState"), System.Windows.Forms.AxHost.State)
        Me.ssgrid.Size = New System.Drawing.Size(992, 192)
        ...
        Me.Cmd_Storecode.Location = New System.Drawing.Point(744, 155)
        ...
        Me.txt_StoreDesc.Location = New System.Drawing.Point(768, 155)
        Me.txt_StoreDesc.MaxLength = 50
        Me.txt_StoreDesc.Name = "txt_StoreDesc"
        Me.txt_StoreDesc.Size = New System.Drawing.Size(136, 26)
        Me.txt_StoreDesc.TabIndex = 429
        Me.txt_StoreDesc.Text = "MAINSTORE"
        '
        'Label3
        '
        ...
        Me.Label3.Location = New System.Drawing.Point(520, 160)
        Me.Label3.Name = "Label3"
        Me.Label3.Size = New System.Drawing.Size(60, 18)
        Me.Label3.TabIndex = 431
        Me.Label3.Text = "STORE :"
        '
        'GRN_Cum_Purchase_Bill_CSC_PO
        '
        ...
        Me.KeyPreview = True
        Me.Name = "GRN_Cum_Purchase_Bill_CSC_PO"
...
#End Region
    ...
    Private Sub GRN_Cum_Purchase_Bill_CSC_PO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Cmd_Clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Clear.Click
        Try
            ...
            Me.Cmd_Freeze.Text = "Void[F8]"
            Cmd_Add.Text = "Add [F7]"
            txt_Storecode.Text = "MNS"
            txt_StoreDesc.Text = "MAINSTORE"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Try
            ...
            If Mid(CStr(Cmd_Add.Text), 1, 1) = "A" Then
                ...
                sqlstring = sqlstring & " Slcode,Slname,Costcentercode,Costcentername,Totalamount,VATamount,Surchargeamt,Discount,Billamount,Remarks,Void,Adduser,Adddate,Updateuser,Updatetime,STORECODE, STOREDESC)"
                ...
                sqlstring = sqlstring & " '" & Trim(CStr(txt_Remarks.Text)) & "','N','" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "','','" & Format(Now, "dd-MMM-yyyy") & "',"
                ...
                For i = 1 To ssgrid.DataRowCnt
                    ...
                    sqlstring = sqlstring & " UOM,Qty,Rate,Discount,TaxPer,TaxAmount,Amount,Dblamount,DblUOM,Highratio,Voiditem,Avgqty,Avgrate,Category,Adduser,Adddate,UpdateUser,Updatetime,STORECODE,STOREDESC)"
                    ...
                    sqlstring = sqlstring & "'" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "','','" & Format(Now, "dd-MMM-yyyy") & "',"
            ...
            ElseIf Mid(CStr(Cmd_Add.Text), 1, 1) = "U" Then
                ...
                For i = 1 To ssgrid.DataRowCnt
                    ...
                    sqlstring = sqlstring & "" & Format(Val(ssgrid.Text), "0.00") & ","
                    sqlstring = sqlstring & "'N'," & Format(Val(Avgquantity), "0.000") & "," & Format(Val(Avgrate), "0.00") & ",'" & Trim(CMB_CATEGORY.Text) & "',"
                    sqlstring = sqlstring & "'" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "','" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "', "
                    sqlstring = sqlstring & "'" & Trim(txt_Storecode.Text) & "','" & Trim(txt_StoreDesc.Text) & "')"
                    ReDim Preserve Insert(Insert.Length)
                    Insert(Insert.Length - 1) = sqlstring
                    '''********************************************* UPDATE PURCHASE RATE IN INVENTORY ITEMMASTER *************************'''
    ...
    Function printoperation()
        Try
            ...
            sqlstring = sqlstring & " ISNULL(D.AMOUNT,0) AS AMOUNT,isnull(d.discount,0) as discount,isnull(d.taxper,0) as taxper,isnull(d.taxamount,0) as taxamount FROM GRN_HEADER AS G INNER JOIN GRN_DETAILS AS D ON G.GRNDETAILS = D.GRNDETAILS"
    ...
    Private Sub txt_Grnno_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_Grnno.Validated
        ...
        If Trim(txt_Grnno.Text) <> "" Then
            Try
                ...
                sqlstring = sqlstring & " ISNULL(STORECODE,'MNS') STORECODE , ISNULL(STOREDESC,'MAINSTORE') STOREDESC FROM GRN_HEADER"
                ...
                If gdataset.Tables("GRNHEADER").Rows.Count > 0 Then
                    ...
                    sqlstring = "SELECT ISNULL(ITEMCODE,'') AS ITEMCODE,ISNULL(PONO,'') PONO,ISNULL(ITEMNAME,'') AS ITEMNAME,ISNULL(UOM,'') AS UOM,"
                    ...
                    If gdataset.Tables("GRNDETAILS").Rows.Count > 0 Then
                        For I = 1 To gdataset.Tables("GRNDETAILS").Rows.Count
                            ...
                            ssgrid.SetText(3, I, Trim(gdataset.Tables("GRNDETAILS").Rows(J).Item("PONO")))
                            ssgrid.Col = 4
                            ssgrid.Row = I
                            ...
                            ssgrid.SetText(5, I, Val(gdataset.Tables("GRNDETAILS").Rows(J).Item("QTY")))
                            ssgrid.SetText(6, I, Format(Val(gdataset.Tables("GRNDETAILS").Rows(J).Item("RATE")), "0.00"))
                            ssgrid.SetText(7, I, Format(Val(gdataset.Tables("GRNDETAILS").Rows(J).Item("DISCOUNT")), "0.00"))
                            ...
                            ssgrid.SetText(11, I, Format(Val(gdataset.Tables("GRNDETAILS").Rows(J).Item("DBLAMOUNT")), "0.00"))
                            ssgrid.SetText(12, I, Trim(gdataset.Tables("GRNDETAILS").Rows(J).Item("DBLUOM")))
                            ssgrid.SetText(13, I, Format(Val(gdataset.Tables("GRNDETAILS").Rows(J).Item("HIGHRATIO")), "0.00"))
                            ssgrid.SetText(14, I, Val(gdataset.Tables("GRNDETAILS").Rows(J).Item("QTY")))
    ...
    Private Sub GRN_Cum_Purchase_Bill_CSC_PO_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            ...
            End If
        Catch ex As Exception
            MessageBox.Show("Plz Check Error : GRN_Cum_Purchase_Bill_CSC_PO_KeyDown " & ex.Message, MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
            Exit Sub
        End Try
    End Sub
    ...
    Private Sub Calculate()
        Try
            ...
            If ssgrid.ActiveCol = 1 Or ssgrid.ActiveCol = 2 Or ssgrid.ActiveCol = 3 Or ssgrid.ActiveCol = 4 Or ssgrid.ActiveCol = 5 Or ssgrid.ActiveCol = 6 Or ssgrid.ActiveCol = 7 Then
                ...
                VALTAXAMOUNT = ValItemamount * (VALTAXPER / 100)
    ...
    Private Sub FillMenu()
        Try
            ...
            vform.vFormatstring1 = "    ITEMCODE    |                     ITEMNAME                    |  STOCKUOM  | PURCHASERATE | CONVUOM | HIGHRATIO |"
    ...
    Private Sub FillMenuItem()
        Try
            ...
            End If
            vform.Field = "I.ITEMNAME,I.ITEMCODE"
            vform.vFormatstring1 = "                     ITEMNAME                |   ITEMCODE    | STOCKUOM  |PURCHASERATE | CONVUOM | HIGHRATIO |"
            vform.vCaption = "INVENTORY ITEM CODE HELP"
            vform.KeyPos = 0
            vform.KeyPos1 = 1
            vform.KeyPos2 = 2
        ...
        Try
            If e.keyCode = Keys.Enter Then
                ...
                ElseIf ssgrid.ActiveCol = 3 Then
                    ...
                    PO = Trim(ssgrid.Text)
                    If PO <> "" Then
                        sqlstring = "SELECT DISTINCT PONO FROM PO_HDR WHERE PONO = '" & PO & "' AND ISNULL(FREEZE,'') <> 'Y' AND ISNULL(POCLOSURE,'') = 'N' AND POVENDORCODE='" & Trim(txt_Suppliercode.Text & "") & "'  AND PONO IN (SELECT PONO FROM PO_ITEMDETAILS WHERE ITEMCODE='" & Itemcode & "')"
                        gconnection.getDataSet(sqlstring, "PO_HDR")
                        If gdataset.Tables("PO_HDR").Rows.Count > 0 Then
                            ssgrid.SetText(2, i, Trim(gdataset.Tables("PO_HDR").Rows(0).Item("PONO")))
                            ssgrid.SetActiveCell(4, ssgrid.ActiveRow)
                            ssgrid.Focus()
                        Else
                            MessageBox.Show("Specified Purchase Order not Available", MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Warning)
                            ssgrid.SetActiveCell(1, ssgrid.ActiveRow)
                            ssgrid.Text = ""
                            ssgrid.Focus()
                            Exit Sub
                ...
                ElseIf ssgrid.ActiveCol = 10 Then
                    ...
                    If ssgrid.Lock = False Then
                        ...
                        Else
                            ...
                            ssgrid.SetText(6, ssgrid.ActiveRow, ItemRate)
                            ssgrid.SetActiveCell(0, ssgrid.ActiveRow + 1)
                        End If
                    End If
    ...
    Private Sub txt_Surchargeamt_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_Surchargeamt.LostFocus
        ...
        End Try
    End Sub
    Private Sub GRN_Cum_Purchase_Bill_CSC_PO_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Try
            GRNCumPurchaseBillTransbool = False
        Catch ex As Exception
            MessageBox.Show("Plz Check Error : GRN_Cum_Purchase_Bill_CSC_PO_Closed" & ex.Message, MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
            Exit Sub
        End Try
    End Sub
    ...
    Private Sub CMB_CATEGORY_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles CMB_CATEGORY.KeyDown
        ...
        End Try
    End Sub
    Private Sub lbl_Grn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbl_Grn.Click

    End Sub
    Private Sub dtp_Grndate_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtp_Grndate.ValueChanged

    End Sub
    Private Sub cbo_Billingterms_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_Billingterms.SelectedIndexChanged
