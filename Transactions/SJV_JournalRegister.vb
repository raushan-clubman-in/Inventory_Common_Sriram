...
Imports System.IO
Public Class SJV_JournalRegister
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents CHK_MAIN As System.Windows.Forms.CheckBox
    Friend WithEvents CHK_SAILING As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SJV_JournalRegister))
        ...
        Me.CHK_SAILING = New System.Windows.Forms.CheckBox
        Me.CHK_MAIN = New System.Windows.Forms.CheckBox
        ...
        Me.Dtp_ToVoucherDate.Location = New System.Drawing.Point(304, 120)
        ...
        Me.GroupBox1.Controls.Add(Me.CHK_SAILING)
        Me.GroupBox1.Controls.Add(Me.CHK_MAIN)
        ...
        'CHK_SAILING
        '
        Me.CHK_SAILING.BackColor = System.Drawing.Color.Transparent
        Me.CHK_SAILING.Font = New System.Drawing.Font("Times New Roman", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.CHK_SAILING.Location = New System.Drawing.Point(288, 64)
        Me.CHK_SAILING.Name = "CHK_SAILING"
        Me.CHK_SAILING.Size = New System.Drawing.Size(168, 24)
        Me.CHK_SAILING.TabIndex = 446
        Me.CHK_SAILING.Text = "SAILING"
        '
        'CHK_MAIN
        '
        Me.CHK_MAIN.BackColor = System.Drawing.Color.Transparent
        Me.CHK_MAIN.Checked = True
        Me.CHK_MAIN.CheckState = System.Windows.Forms.CheckState.Checked
        Me.CHK_MAIN.Font = New System.Drawing.Font("Times New Roman", 12.0!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.CHK_MAIN.Location = New System.Drawing.Point(72, 68)
        Me.CHK_MAIN.Name = "CHK_MAIN"
        Me.CHK_MAIN.Size = New System.Drawing.Size(168, 24)
        Me.CHK_MAIN.TabIndex = 445
        Me.CHK_MAIN.Text = "MAIN"
        '
        'Dtp_FromVoucherDate
        '
        ...
        Me.Dtp_FromVoucherDate.Location = New System.Drawing.Point(120, 120)
        ...
        Me.Label10.Size = New System.Drawing.Size(467, 31)
        Me.Label10.TabIndex = 123
        Me.Label10.Text = "SPECIAL PARTY JOURNAL REGISTER"
        ...
        Me.Grp_AccountPosting.Location = New System.Drawing.Point(8, 16)
        Me.Grp_AccountPosting.Name = "Grp_AccountPosting"
        Me.Grp_AccountPosting.Size = New System.Drawing.Size(1008, 624)
        Me.Grp_AccountPosting.TabIndex = 128
        Me.Grp_AccountPosting.TabStop = False
        '
        'cmd_export
        '
        Me.cmd_export.BackColor = System.Drawing.Color.FromArgb(CType(141, Byte), CType(154, Byte), CType(156, Byte))
        Me.cmd_export.DialogResult = System.Windows.Forms.DialogResult.Cancel
        Me.cmd_export.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.cmd_export.ForeColor = System.Drawing.SystemColors.ActiveCaptionText
        ...
        Me.GrdAuditTrail.Location = New System.Drawing.Point(16, 48)
        ...
        Me.GrdAuditTrail.Size = New System.Drawing.Size(976, 528)
        ...
        Me.KeyPreview = True
        Me.Name = "SJV_JournalRegister"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "SJV_JournalRegister"
...
#End Region
    Private Sub SJV_JournalRegister_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Show()
    ...
    Private Sub CmdExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdExit.Click
        ...
        End Try
    End Sub
    Private Sub SJV_JournalRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub GridOperation()
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            strsql = "EXEC SJV_POSTING " & "'" & Format(Dtp_FromVoucherDate.Value, "dd-MMM-yyyy") & "','" & Format(Dtp_ToVoucherDate.Value, "dd-MMM-yyyy") & "','T','" & Trim(LOCCODE) & "'"
            ...
            ssql = ssql & " AND ISNULL(FREEZEUSERID,'')<>'Y'"
    ...
    Private Sub CMD_POST_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_POST.Click
        Try
            ...
            Dim STRSQL As String
            Me.Cursor = Cursors.WaitCursor
            STRSQL = "EXEC SJV_POSTING " & "'" & Format(Dtp_FromVoucherDate.Value, "dd-MMM-yyyy") & "','" & Format(Dtp_ToVoucherDate.Value, "dd-MMM-yyyy") & "','P','" & Trim(LOCCODE) & "'"
            VCONN.dataOperation(6, STRSQL, "ACCOUNTPOSTING")
            Me.Cursor = Cursors.Default
    ...
    End Sub
    Private Sub CHK_MAIN_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CHK_MAIN.CheckedChanged
        If CHK_MAIN.Checked = True Then
            CHK_SAILING.Checked = False
            LOCCODE = "A"
        End If
    End Sub
    Private Sub CHK_SAILING_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CHK_SAILING.CheckedChanged
        If CHK_SAILING.Checked = True Then
