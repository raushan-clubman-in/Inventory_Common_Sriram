...
Imports System.IO
Public Class GJV_JournalRegister
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GJV_JournalRegister))
        ...
        Me.Label10.Size = New System.Drawing.Size(521, 31)
        Me.Label10.TabIndex = 123
        Me.Label10.Text = "TRANSIT QUARTERS JOURNAL REGISTER"
        ...
        Me.Grp_AccountPosting.Location = New System.Drawing.Point(24, 24)
...
#End Region
    Private Sub GJV_JournalRegister_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Show()
    ...
    Private Sub GJV_JournalRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub GridOperation()
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            strsql = "EXEC GJV_POSTING " & "'" & Format(Dtp_FromVoucherDate.Value, "dd-MMM-yyyy") & "','" & Format(Dtp_ToVoucherDate.Value, "dd-MMM-yyyy") & "','T'"
    ...
    Private Sub CMD_POST_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMD_POST.Click
        Try
            ...
            Dim STRSQL As String
            Me.Cursor = Cursors.WaitCursor
            STRSQL = "EXEC GJV_POSTING " & "'" & Format(Dtp_FromVoucherDate.Value, "dd-MMM-yyyy") & "','" & Format(Dtp_ToVoucherDate.Value, "dd-MMM-yyyy") & "','P'"
            VCONN.dataOperation(6, STRSQL, "ACCOUNTPOSTING")
            Me.Cursor = Cursors.Default
