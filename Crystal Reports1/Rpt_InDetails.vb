...
Public Class Rpt_InDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_InDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_InDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_InDetails = New Rpt_InDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
