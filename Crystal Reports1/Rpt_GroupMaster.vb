...
Public Class Rpt_GroupMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GroupMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GroupMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GroupMaster = New Rpt_GroupMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
