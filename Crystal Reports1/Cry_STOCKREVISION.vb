...
Public Class Cry_STOCKREVISION
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cry_STOCKREVISION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_STOCKREVISION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_STOCKREVISION = New Cry_STOCKREVISION()
        rpt.Site = Me.Site
        Return rpt
    End Function
