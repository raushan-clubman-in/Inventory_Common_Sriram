...
Public Class Rpt_StockTransfer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StockTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StockTransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StockTransfer = New Rpt_StockTransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
