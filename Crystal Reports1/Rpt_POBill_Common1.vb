...
Public Class Rpt_POBill_Common
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_POBill_Common.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_POBill_Common
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_POBill_Common = New Rpt_POBill_Common()
        rpt.Site = Me.Site
        Return rpt
    End Function
