...
Public Class Rpt_PrnBillIGST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_PrnBillIGST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PrnBillIGST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PrnBillIGST = New Rpt_PrnBillIGST()
        rpt.Site = Me.Site
        Return rpt
    End Function
