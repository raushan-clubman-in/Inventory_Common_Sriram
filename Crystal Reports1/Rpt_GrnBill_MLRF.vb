...
Public Class Rpt_GrnBill_MLRF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GrnBill_MLRF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GrnBill_MLRF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GrnBill_MLRF = New Rpt_GrnBill_MLRF()
        rpt.Site = Me.Site
        Return rpt
    End Function
