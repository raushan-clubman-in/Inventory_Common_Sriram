...
Public Class Rpt_Indentbill_KGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Indentbill_KGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Indentbill_KGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Indentbill_KGA = New Rpt_Indentbill_KGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
