...
Public Class Rpt_StkInBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StkInBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StkInBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StkInBill = New Rpt_StkInBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
