...
Public Class Rpt_GrnBiLL_SKYYE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GrnBiLL_SKYYE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GrnBiLL_SKYYE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GrnBiLL_SKYYE = New Rpt_GrnBiLL_SKYYE()
        rpt.Site = Me.Site
        Return rpt
    End Function
