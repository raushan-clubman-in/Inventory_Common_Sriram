...
Public Class Rpt_SubgroupMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_SubgroupMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SubgroupMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SubgroupMaster = New Rpt_SubgroupMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
