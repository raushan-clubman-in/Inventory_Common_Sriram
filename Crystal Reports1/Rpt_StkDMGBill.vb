...
Public Class Rpt_StkDMGBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StkDMGBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StkDMGBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StkDMGBill = New Rpt_StkDMGBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
