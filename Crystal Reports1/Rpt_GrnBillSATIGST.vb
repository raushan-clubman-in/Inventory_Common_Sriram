...
Public Class Rpt_GrnBillSATIGST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GrnBillSATIGST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GrnBillSATIGST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GrnBillSATIGST = New Rpt_GrnBillSATIGST()
        rpt.Site = Me.Site
        Return rpt
    End Function
