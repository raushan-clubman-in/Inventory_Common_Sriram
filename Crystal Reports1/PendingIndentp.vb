...
Public Class PendingIndentp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.PendingIndentp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPendingIndentp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PendingIndentp = New PendingIndentp()
        rpt.Site = Me.Site
        Return rpt
    End Function
