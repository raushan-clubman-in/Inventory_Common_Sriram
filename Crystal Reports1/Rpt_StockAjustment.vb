...
Public Class Rpt_StockAjustment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StockAjustment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StockAjustment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StockAjustment = New Rpt_StockAjustment()
        rpt.Site = Me.Site
        Return rpt
    End Function
