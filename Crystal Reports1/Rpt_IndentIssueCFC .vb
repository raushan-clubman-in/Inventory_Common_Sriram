...
Public Class Rpt_IndentIssueCFC_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IndentIssueCFC .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IndentIssueCFC_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IndentIssueCFC_ = New Rpt_IndentIssueCFC_()
        rpt.Site = Me.Site
        Return rpt
    End Function
