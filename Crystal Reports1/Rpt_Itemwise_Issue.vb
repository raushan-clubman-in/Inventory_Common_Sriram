...
Public Class Rpt_Itemwise_Issue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Itemwise_Issue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Itemwise_Issue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Itemwise_Issue = New Rpt_Itemwise_Issue()
        rpt.Site = Me.Site
        Return rpt
    End Function
