...
Public Class CryPOGSTNEW_BGC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CryPOGSTNEW_BGC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPOGSTNEW_BGC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPOGSTNEW_BGC = New CryPOGSTNEW_BGC()
        rpt.Site = Me.Site
        Return rpt
    End Function
