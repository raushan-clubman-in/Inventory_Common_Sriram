...
Public Class Rpt_IndentbillCFC_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IndentbillCFC .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IndentbillCFC_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IndentbillCFC_ = New Rpt_IndentbillCFC_()
        rpt.Site = Me.Site
        Return rpt
    End Function
