...
Public Class Rpt_IssueDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IssueDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IssueDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IssueDetails = New Rpt_IssueDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
