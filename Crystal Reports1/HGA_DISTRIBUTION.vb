...
Public Class HGA_DISTRIBUTION
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.HGA_DISTRIBUTION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHGA_DISTRIBUTION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HGA_DISTRIBUTION = New HGA_DISTRIBUTION()
        rpt.Site = Me.Site
        Return rpt
    End Function
