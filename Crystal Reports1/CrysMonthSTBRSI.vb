...
Public Class CrysMonthSTBRSI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.CrysMonthSTBRSI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysMonthSTBRSI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysMonthSTBRSI = New CrysMonthSTBRSI()
        rpt.Site = Me.Site
        Return rpt
    End Function
