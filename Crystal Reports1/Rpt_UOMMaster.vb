...
Public Class Rpt_UOMMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_UOMMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_UOMMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_UOMMaster = New Rpt_UOMMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
