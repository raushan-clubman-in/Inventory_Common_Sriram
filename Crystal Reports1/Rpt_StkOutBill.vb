...
Public Class Rpt_StkOutBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StkOutBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StkOutBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StkOutBill = New Rpt_StkOutBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
