...
Public Class Rpt_InDetails_item
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_InDetails_item.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_InDetails_item
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_InDetails_item = New Rpt_InDetails_item()
        rpt.Site = Me.Site
        Return rpt
    End Function
