...
Public Class Cry_STOCKEXPMESS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cry_STOCKEXPMESS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_STOCKEXPMESS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_STOCKEXPMESS = New Cry_STOCKEXPMESS()
        rpt.Site = Me.Site
        Return rpt
    End Function
