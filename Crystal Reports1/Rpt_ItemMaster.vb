...
Public Class Rpt_ItemMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_ItemMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ItemMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ItemMaster = New Rpt_ItemMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
