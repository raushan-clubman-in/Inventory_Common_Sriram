...
Public Class Rpt_IndentIssueHG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IndentIssueHG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IndentIssueHG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IndentIssueHG = New Rpt_IndentIssueHG()
        rpt.Site = Me.Site
        Return rpt
    End Function
