...
Public Class Rpt_StockLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StockLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StockLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StockLedger = New Rpt_StockLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
