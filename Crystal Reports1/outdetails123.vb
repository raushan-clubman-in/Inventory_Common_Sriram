...
Public Class outdetails123
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.outdetails123.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedoutdetails123
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As outdetails123 = New outdetails123()
        rpt.Site = Me.Site
        Return rpt
    End Function
