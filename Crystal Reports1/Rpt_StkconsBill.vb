...
Public Class Rpt_StkconsBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StkconsBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StkconsBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StkconsBill = New Rpt_StkconsBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
