...
Public Class Rpt_PERMITKGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_PERMITKGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PERMITKGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PERMITKGA = New Rpt_PERMITKGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
