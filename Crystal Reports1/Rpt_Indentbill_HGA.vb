...
Public Class Rpt_Indentbill_HGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Indentbill_HGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Indentbill_HGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Indentbill_HGA = New Rpt_Indentbill_HGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
