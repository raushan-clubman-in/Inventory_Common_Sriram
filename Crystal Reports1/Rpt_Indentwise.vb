...
Public Class Rpt_Indentwise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Indentwise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Indentwise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Indentwise = New Rpt_Indentwise()
        rpt.Site = Me.Site
        Return rpt
    End Function
