...
Public Class Rpt_SUMMARYKGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_SUMMARYKGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SUMMARYKGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SUMMARYKGA = New Rpt_SUMMARYKGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
