...
Public Class Rpt_ROL_Summary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_ROL_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ROL_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ROL_Summary = New Rpt_ROL_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
