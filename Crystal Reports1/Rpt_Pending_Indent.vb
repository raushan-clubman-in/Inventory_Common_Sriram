...
Public Class Rpt_Pending_Indent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Pending_Indent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Pending_Indent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Pending_Indent = New Rpt_Pending_Indent()
        rpt.Site = Me.Site
        Return rpt
    End Function
