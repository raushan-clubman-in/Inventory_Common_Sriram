...
Public Class Cry_nightaudit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cry_nightaudit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_nightaudit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_nightaudit = New Cry_nightaudit()
        rpt.Site = Me.Site
        Return rpt
    End Function
