...
Public Class Rpt_stk_catsummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_stk_catsummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_stk_catsummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_stk_catsummary = New Rpt_stk_catsummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
