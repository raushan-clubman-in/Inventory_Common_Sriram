...
Public Class Rpt_IssueSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IssueSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IssueSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IssueSummary = New Rpt_IssueSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
