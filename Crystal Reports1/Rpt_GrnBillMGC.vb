...
Public Class Rpt_GrnBillMGC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GrnBillMGC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GrnBillMGC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GrnBillMGC = New Rpt_GrnBillMGC()
        rpt.Site = Me.Site
        Return rpt
    End Function
