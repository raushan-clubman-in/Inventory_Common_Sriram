...
Public Class Rpt_OutDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_OutDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_OutDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_OutDetails = New Rpt_OutDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
