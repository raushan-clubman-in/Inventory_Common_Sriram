...
Public Class Rpt_GrnBillGSTNEW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GrnBillGSTNEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GrnBillGSTNEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GrnBillGSTNEW = New Rpt_GrnBillGSTNEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
