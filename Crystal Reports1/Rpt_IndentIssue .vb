...
Public Class Rpt_IndentIssue_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IndentIssue .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IndentIssue_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IndentIssue_ = New Rpt_IndentIssue_()
        rpt.Site = Me.Site
        Return rpt
    End Function
