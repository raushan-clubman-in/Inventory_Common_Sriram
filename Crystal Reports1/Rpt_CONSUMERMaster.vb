...
Public Class Rpt_CONSUMERMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_CONSUMERMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CONSUMERMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CONSUMERMaster = New Rpt_CONSUMERMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
