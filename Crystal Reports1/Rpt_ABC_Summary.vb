...
Public Class Rpt_ABC_Summary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_ABC_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ABC_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ABC_Summary = New Rpt_ABC_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
