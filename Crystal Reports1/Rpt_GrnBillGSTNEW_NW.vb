...
Public Class Rpt_GrnBillGSTNEW_NW
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_GrnBillGSTNEW_NW.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_GrnBillGSTNEW_NW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GrnBillGSTNEW_NW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GrnBillGSTNEW_NW = New Rpt_GrnBillGSTNEW_NW()
        rpt.Site = Me.Site
        Return rpt
    End Function
