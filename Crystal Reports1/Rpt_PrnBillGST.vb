...
Public Class Rpt_PrnBillGST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_PrnBillGST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PrnBillGST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PrnBillGST = New Rpt_PrnBillGST()
        rpt.Site = Me.Site
        Return rpt
    End Function
