...
Public Class RPT_CATEGORYMASTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.RPT_CATEGORYMASTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CATEGORYMASTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CATEGORYMASTER = New RPT_CATEGORYMASTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
