...
Public Class Rpt_Itemmaster_stk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Itemmaster_stk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Itemmaster_stk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Itemmaster_stk = New Rpt_Itemmaster_stk()
        rpt.Site = Me.Site
        Return rpt
    End Function
