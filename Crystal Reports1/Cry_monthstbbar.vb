...
Public Class Cry_monthstbbar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cry_monthstbbar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_param() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCry_monthstbbar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_monthstbbar = New Cry_monthstbbar()
        rpt.Site = Me.Site
        Return rpt
    End Function
