...
Public Class Rpt_Itemwise_Issue_BBSR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_Itemwise_Issue_BBSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Itemwise_Issue_BBSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Itemwise_Issue_BBSR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Itemwise_Issue_BBSR = New Rpt_Itemwise_Issue_BBSR()
        rpt.Site = Me.Site
        Return rpt
    End Function
