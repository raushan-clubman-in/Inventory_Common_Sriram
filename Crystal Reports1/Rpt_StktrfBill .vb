...
Public Class Rpt_StktrfBill_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StktrfBill .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StktrfBill_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StktrfBill_ = New Rpt_StktrfBill_()
        rpt.Site = Me.Site
        Return rpt
    End Function
