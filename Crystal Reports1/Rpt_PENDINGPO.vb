...
Public Class Rpt_PENDINGPO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_PENDINGPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PENDINGPO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PENDINGPO = New Rpt_PENDINGPO()
        rpt.Site = Me.Site
        Return rpt
    End Function
