...
Public Class subsubgroupreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.subsubgroupreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsubsubgroupreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subsubgroupreport = New subsubgroupreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
