...
Public Class Rpt_StoreMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_StoreMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StoreMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StoreMaster = New Rpt_StoreMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
