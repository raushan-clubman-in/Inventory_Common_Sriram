...
Public Class Crys_EXTRMESS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Crys_EXTRMESS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_EXTRMESS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_EXTRMESS = New Crys_EXTRMESS()
        rpt.Site = Me.Site
        Return rpt
    End Function
