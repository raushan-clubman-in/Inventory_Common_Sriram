...
Public Class Rpt_IssueRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_IssueRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_IssueRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_IssueRegister = New Rpt_IssueRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
