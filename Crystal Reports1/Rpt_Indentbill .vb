...
Public Class Rpt_Indentbill_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Rpt_Indentbill .rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Indentbill_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Indentbill_ = New Rpt_Indentbill_()
        rpt.Site = Me.Site
        Return rpt
    End Function
