...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(List_Operation))
...
#End Region
    ...
    Public keyfield17 As String
    Public keyfield18 As String
    ...
    Public keypos14 As Integer, Keypos15 As Integer, Keypos17 As Integer, Keypos18 As Integer
   
    Private Sub List_Operation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FormUnload = True
        Fields = Split(Field, ",")
        vSelect = Field
        ...
        End If
        POSListoperation.FormatString = vFormatstring1
    ...
    Private Sub getDetails()
        ...
        keyfield17 = POSListoperation.get_TextMatrix(POSListoperation.Row, Keypos17)
        keyfield18 = POSListoperation.get_TextMatrix(POSListoperation.Row, Keypos18)
        M_Groupby = ""
        M_WhereCondition = ""
        Me.Hide()
    End Sub
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        ...
        vFormatstring1 = POSListoperation.FormatString
        ...
        If ssql <> "" Then
            ...
            'vConn.dataOperation(5, ssql, "MyTable")
    ...
    Private Sub List_Operation_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub List_Operation_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
