...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_HSNNO_Update))
        ...
        Me.grpSearch.Controls.Add(Me.lblname)
        Me.grpSearch.Controls.Add(Me.LBLcode)
        ...
        Me.grpSearch.Location = New System.Drawing.Point(8, 8)
        Me.grpSearch.Name = "grpSearch"
        Me.grpSearch.Size = New System.Drawing.Size(547, 146)
        ...
        Me.lblname.Location = New System.Drawing.Point(256, 16)
        ...
        Me.LBLcode.Font = New System.Drawing.Font("Times New Roman", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.LBLcode.Location = New System.Drawing.Point(139, 16)
        Me.LBLcode.Name = "LBLcode"
        Me.LBLcode.Size = New System.Drawing.Size(42, 15)
        Me.LBLcode.TabIndex = 156
        ...
        Me.btnCancel.Location = New System.Drawing.Point(278, 75)
        ...
        Me.Label5.Location = New System.Drawing.Point(57, 16)
        ...
        Me.btnSearch.Location = New System.Drawing.Point(142, 75)
        ...
        Me.txtSearch.Location = New System.Drawing.Point(142, 43)
        ...
        Me.ClientSize = New System.Drawing.Size(567, 166)
        Me.Controls.Add(Me.grpSearch)
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog
        Me.Icon = CType(resources.GetObject("$this.Icon"), System.Drawing.Icon)
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.Name = "frm_HSNNO_Update"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "HSN NO. UPDATE"
...
#End Region
    ...
    Public ITEMCODE, ITEMNAME, sqll As String
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If txtSearch.Text <> "" Then
            sqll = "update inv_inventoryitemmaster set hsnno='" + txtSearch.Text + "'  where itemcode='" & LBLcode.Text & "' "
            gconnection.dataOperation(6, sqll, )
            Me.Close()
        Else
            MsgBox("HSNNO Can't Be Blank....", MsgBoxStyle.OkOnly, gCompanyname)
        End If
    ...
    Private Sub frm_HSNNO_Update_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        If ITEMCODE <> "" Then
            Dim SQL As String = "SELECT * FROM INV_INVENTORYITEMMASTER WHERE itemcode='" & ITEMCODE & "'"
            gconnection.getDataSet(SQL, "INV_INVENTORYITEMMASTER")
            If gdataset.Tables("INV_INVENTORYITEMMASTER").Rows.Count > 0 Then
                lblname.Text = gdataset.Tables("INV_INVENTORYITEMMASTER").Rows(0).Item("itemname")
                LBLcode.Text = gdataset.Tables("INV_INVENTORYITEMMASTER").Rows(0).Item("itemcode")
            End If
        End If
    End Sub
