...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ListOperattion1))
        ...
        Me.CbxColumn.Location = New System.Drawing.Point(-28, -39)
        Me.CbxColumn.Name = "CbxColumn"
        Me.CbxColumn.Size = New System.Drawing.Size(208, 24)
        Me.CbxColumn.TabIndex = 4
        '
        'CbxOrderby
        '
        Me.CbxOrderby.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
        Me.CbxOrderby.Location = New System.Drawing.Point(513, 49)
        Me.CbxOrderby.Name = "CbxOrderby"
        Me.CbxOrderby.Size = New System.Drawing.Size(193, 24)
        ...
        Me.Label1.Location = New System.Drawing.Point(411, 49)
        ...
        Me.txtSearch.Location = New System.Drawing.Point(149, 49)
        Me.txtSearch.MaxLength = 50
        Me.txtSearch.Name = "txtSearch"
        Me.txtSearch.Size = New System.Drawing.Size(577, 26)
        ...
        Me.lblHeading.Location = New System.Drawing.Point(300, 0)
        Me.lblHeading.Name = "lblHeading"
        Me.lblHeading.Size = New System.Drawing.Size(91, 19)
        Me.lblHeading.TabIndex = 7
        Me.lblHeading.Text = "lblHeading"
        '
        'POSListoperation
        '
        Me.POSListoperation.Location = New System.Drawing.Point(9, 118)
        ...
        Me.POSListoperation.Size = New System.Drawing.Size(725, 374)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(717, 88)
...
#End Region
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        ...
        POSListoperation.Clear()
            POSListoperation.FormatString = vFormatstring
            POSListoperation.set_ColAlignment(1, 1)
            POSListoperation.set_ColAlignment(0, 1)
        ...
        ssql = gSQLString & IIf(Trim(M_WhereCondition) = "", " Where ", M_WhereCondition & " And ")
            ...
            If sqlstring <> "" Then
                vLen = Len(Trim(txtSearch.Text))
                ssql = ssql & Trim(sqlstring & "") & " LIKE '%" & Trim(txtSearch.Text) & "%'"
            ...
            Else
                If CbxOrderby.Text <> "" Then
                    ssql = ssql & M_Groupby
                    If M_ORDERBY <> "" Then
                        ssql = ssql & " order by " & M_ORDERBY

                    Else
                        ssql = ssql & " order by " & Trim(CbxOrderby.Text)
                    End If
                ElseIf M_Groupby <> "" Then
                    ssql = ssql & M_Groupby
                    ' 
                End If
                If M_ORDERBY <> "" Then
    ...
    Private Sub ListOperattion1_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
