...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(136, 56)
        ...
        'OptFP
        '
        Me.OptFP.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.OptFP.ForeColor = System.Drawing.Color.Black
        Me.OptFP.Location = New System.Drawing.Point(552, 13)
        Me.OptFP.Name = "OptFP"
        ...
        'OptDU
        '
        Me.OptDU.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.OptDU.ForeColor = System.Drawing.Color.Black
        Me.OptDU.Location = New System.Drawing.Point(416, 13)
        Me.OptDU.Name = "OptDU"
        ...
        'OptCR
        '
        Me.OptCR.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.OptCR.ForeColor = System.Drawing.Color.Black
        Me.OptCR.Location = New System.Drawing.Point(280, 12)
        Me.OptCR.Name = "OptCR"
        ...
        'OptCP
        '
        Me.OptCP.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.OptCP.ForeColor = System.Drawing.Color.Black
        Me.OptCP.Location = New System.Drawing.Point(128, 12)
        Me.OptCP.Name = "OptCP"
        ...
        Me.OptCU.Font = New System.Drawing.Font("Verdana", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'gbNew
        '
        Me.gbNew.BackColor = System.Drawing.Color.Transparent
        ...
        Me.gbNew.Location = New System.Drawing.Point(168, 112)
        Me.gbNew.Name = "gbNew"
        ...
        'lbl_confirm
        '
        Me.lbl_confirm.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.gbUsers.Location = New System.Drawing.Point(568, 104)
        ...
        Me.Ssgrid.Location = New System.Drawing.Point(168, 232)
        ...
        Me.CmdDELETE.Location = New System.Drawing.Point(344, 16)
        ...
        Me.CmdAdd.Location = New System.Drawing.Point(192, 16)
        ...
        Me.Lbl_Forget.Location = New System.Drawing.Point(456, 96)
        Me.Lbl_Forget.Name = "Lbl_Forget"
        Me.Lbl_Forget.Size = New System.Drawing.Size(104, 48)
...
#End Region
    ...
    Private Sub GetRights()
        ...
        ssql = ssql & "where UserName='" & UserName & "' and M.PackageName='INVENTORY' "
        ...
        Try
            ...
            If Me.OptDU.Checked = True Then
                ...
                If Trim(Me.txtusername.Text) <> "" Then
                    qry(0) = "Delete From Master..UserAdmin  where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='INVENTORY' "
                    qry(1) = "Delete From UserAdmin  where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='INVENTORY' "
                    conn.MoreTrans(qry)
                Else
    ...
    Public Sub Addoperation()
        ...
        If OptCU.Checked = True Or Me.OptCR.Checked = True Then
                ...
                If Trim(Vmain & "") <> "" Then
                    ...
                    If Trim(vDesc & "") <> "" Then
                        ...
                        With ds.Tables(0).Rows(0)
                            ...
                            " Values('" & Trim(vUserName) & "','" & Trim(vUserPassword) & "','U','" & Trim(.Item("MainModuleId") & "") & "','" & Trim(.Item("SubModuleid") & "") & "','" & Trim(.Item("SsubModuleid") & "") & "','" & Trim(abcdADD(vDesc) & "") & "','" & Trim(Mname) & "','INVENTORY')"
                            aryindex = aryindex + 1
                        End With
                    End If
                    vDesc = ""
            ...
            qry(qry.Length - 1) = "Insert into Master..UserAdmin(UserName,UserPassword,Category,MainGroup) " & _
             " values('" & Trim(vUserName) & "','" & Trim(vUserPassword) & "','U','INVENTORY')"
            If Me.OptCU.Checked = True Then
                conn.MoreTrans(qry)
            ElseIf Me.OptCR.Checked = True Then
                Dim str(qry.Length + 1) As String
                str(0) = "Delete From Master..UserAdmin  where UserName='" & Trim(Me.txtusername.Text) & "' AND MainGroup='INVENTORY'"
                str(1) = "Delete From UserAdmin  where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='INVENTORY'"
        ...
        If Me.OptCP.Checked = True Then
            ReDim qry(1)
            If Trim(Me.txtusername.Text) <> "" Then
                qry(0) = "Update UserAdmin Set userpassword='" & Trim(abcdADD(Me.txtPassword.Text)) & "' where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='INVENTORY' "
                qry(1) = "Update Master..UserAdmin Set userpassword='" & Trim(abcdADD(Me.txtPassword.Text)) & "' where UserName='" & Trim(Me.txtusername.Text) & "' AND  MainGroup='INVENTORY' "
                conn.MoreTrans(qry)
                Call ClearOperation()
                Exit Sub
            Else
    ...
    Sub getusers()
        ...
        ds = conn.getdata("Select distinct UserName from useradmin WHERE IsNull(Category,'') <> 'S' and MainGroup='INVENTORY'", "User")
        If ds.Tables(0).Rows.Count > 0 Then
        ...
        Else
            MsgBox("No Users Aviliable", MsgBoxStyle.Information, "INVENTORY")
            ' Me.ClearOperation()
            Exit Sub
        End If
    End Sub
    Private Sub lstUsers_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstUsers.Click
        ...
        If Me.lstUsers.Items.Count > 0 Then
            Dim ds As New DataSet
            ds = conn.getdata("Select * from useradmin where username='" & Me.lstUsers.Items.Item(lstUsers.SelectedIndex) & "' And MainGroup='INVENTORY' ", "User")
    ...
    Sub UserDetails(ByVal UserName As String)
        ...
        Dim Vdesc As String
        Dim vmain As Double
        ds = conn.getdata("Select isnull(ModuleName,0) as ModuleName,Isnull(Rights,'') as Rights From UserAdmin where UserName='" & UserName & "' And MainGroup='INVENTORY'", "User")
        If ds.Tables(0).Rows.Count > 0 Then
    ...
    Private Sub OptCR_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OptCR.CheckedChanged
