...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(144, 48)
        ...
        Me.gbNew.Location = New System.Drawing.Point(128, 88)
        Me.gbNew.Name = "gbNew"
        ...
        Me.gbUsers.Location = New System.Drawing.Point(640, 88)
        ...
        Me.lstUsers.Location = New System.Drawing.Point(8, 10)
        ...
        Me.Label4.Location = New System.Drawing.Point(112, 224)
        Me.Label4.Name = "Label4"
        Me.Label4.Size = New System.Drawing.Size(520, 16)
        ...
        Me.Ssgrid.Location = New System.Drawing.Point(128, 256)
        ...
        Me.Lbl_Forget.Location = New System.Drawing.Point(496, 88)
        ...
        Me.cmdExit.Location = New System.Drawing.Point(664, 528)
        ...
        Me.cmdDelete.Location = New System.Drawing.Point(528, 528)
        ...
        Me.cmdClear.Location = New System.Drawing.Point(272, 528)
        ...
        Me.cmdAdd.Location = New System.Drawing.Point(400, 528)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(264, 512)
...
#End Region
    ...
    Private Sub GetRights()
        ...
        Sqlstring = Sqlstring & " WHERE USERNAME = '" & Trim(UserName) & "' AND ISNULL(M.PACKAGENAME,'') ='INVENTORY' "
    ...
    Private Sub FillModules()
        ...
        Sqlstring = Sqlstring & "ISNULL(SUBMODULENAME,'') AS SUBMODULENAME,ISNULL(SSUBMODULEID,'') AS SSUBMODULEID,ISNULL(SSUBMODULENAME,'') AS SSUBMODULENAME  FROM MODULEMASTER WHERE PACKAGENAME = 'INVENTORY' ORDER BY MAINMODULEID,MAINMODULENAME"
            ...
            For Loopindex = 0 To gdataset.Tables("USER").Rows.Count - 1
                With gdataset.Tables("USER").Rows(Loopindex)
                    ...
                    If vSsub <> Trim(.Item("SsubModuleID") & "") Then
                        ...
                        vMain = Trim(.Item("mainModuleId") & "")
                        Sqlstring = "SELECT ISNULL(ROWID,0) AS ROWID,ISNULL(MAINMODULEID,'') AS MAINMODULEID,ISNULL(MAINMODULENAME,'') AS MAINMODULENAME,ISNULL(SUBMODULEID,'') AS SUBMODULEID,"
                        Sqlstring = Sqlstring & "ISNULL(SUBMODULENAME,'') AS SUBMODULENAME,ISNULL(SSUBMODULEID,'') AS SSUBMODULEID,ISNULL(SSUBMODULENAME,'') AS SSUBMODULENAME  FROM MODULEMASTER WHERE PACKAGENAME = 'INVENTORY' AND MAINMODULEID ='" & Trim(vMain) & "' AND SUBMODULEID ='" & Trim(vSub) & "' ORDER BY MAINMODULEID,MAINMODULENAME"
    ...
    Public Sub Addoperation()
        ...
        If OptCU.Checked = True Or Me.OptCR.Checked = True Then
            ...
            ElseIf Me.OptCR.Checked = True Then
                ...
                str(1) = "DELETE FROM MASTER..USERADMIN WHERE  UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='INVENTORY'"
    ...
    Sub getusers()
        ...
        Sqlstring = "SELECT DISTINCT ISNULL(USERNAME,'') AS USERNAME FROM USERADMIN WHERE ISNULL(CATEGORY,'') <> 'S' AND MAINGROUP = 'INVENTORY'"
        gconnection.getDataSet(Sqlstring, "USER")
        If gdataset.Tables("USER").Rows.Count > 0 Then
    ...
    Private Sub lstUsers_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstUsers.Click
        ...
        Try
            If Me.lstUsers.Items.Count > 0 Then
                Sqlstring = "SELECT * FROM USERADMIN WHERE USERNAME = '" & Me.lstUsers.Items.Item(lstUsers.SelectedIndex) & "' AND MAINGROUP = 'INVENTORY' "
                gconnection.getDataSet(Sqlstring, "USER")
                If gdataset.Tables("USER").Rows.Count > 0 Then
    ...
    Sub UserDetails(ByVal UserName As String)
        ...
        Dim vmain As Double
        Sqlstring = "SELECT ISNULL(MODULENAME,0) AS MODULENAME,ISNULL(RIGHTS,'') AS RIGHTS FROM USERADMIN WHERE USERNAME = '" & Trim(UserName) & "' AND MAINGROUP = 'INVENTORY' "
        gconnection.getDataSet(Sqlstring, "USER")
        If gdataset.Tables("USER").Rows.Count > 0 Then
