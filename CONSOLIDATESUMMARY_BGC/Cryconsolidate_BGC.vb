...
Public Class Cryconsolidate_BGC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Cryconsolidate_BGC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryconsolidate_BGC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cryconsolidate_BGC = New Cryconsolidate_BGC()
        rpt.Site = Me.Site
        Return rpt
    End Function
